<?php
// producto-cable-usb-belkin.php - Cable USB-A a Lightning Belkin 1m
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cable USB-A a Lightning Belkin</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada664b7656a2f49.jpg" alt="Cable USB-A a Lightning Belkin 1m">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Belkin • Cable USB-A a Lightning • Zona Móvil</div>
        <h1 id="prodTitle">Cable USB-A a Lightning Belkin – 1 metro</h1>
        <div class="price" id="prodPrice">$14.20</div>
        <div class="desc" id="prodDesc">
          Cable de carga y sincronización para dispositivos Apple, de 1 metro de longitud, fabricado por Belkin con materiales duraderos.
        </div>
        <ul class="puntos">
          <li>Longitud: 1 metro</li>
          <li>Compatible con iPhone, iPad y iPod</li>
          <li>Carga y sincronización eficiente</li>
          <li>Conector USB-A a Lightning</li>
          <li>Durable y flexible</li>
        </ul>
        <div class="options">
          <div class="qty">
