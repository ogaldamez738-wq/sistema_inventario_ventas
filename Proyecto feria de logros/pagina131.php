<?php
// producto-xbox-series-s-1tb.php - versión individual con precio final $499.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Xbox Series S 1TB SSD VRR HDR Blanco</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/DJPUYYAEij4TymSssMXuA4nW02cCIKEEdpw6vd28.png" alt="Consola Xbox Series S 1TB SSD VRR HDR Blanco">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Consola • XBOX • Zona Gamer</div>
        <h1 id="prodTitle">Consola de videojuegos Xbox Series S SSD 1TB VRR HDR Blanco</h1>
        <div class="price" id="prodPrice">$499.00</div>

        <div class="desc" id="prodDesc">
          • Consola digital de nueva generación sin unidad de disco.<br>
          • Almacenamiento SSD ultrarrápido de 1TB para cargas casi instantáneas.<br>
          • Soporte para <strong>HDR</strong> y <strong>VRR</strong> (frecuencia de actualización variable).<br>
          • Resolución hasta 1440p con reescalado 4K para streaming y reproducción multimedia.<br>
          • Compatible con miles de juegos de Xbox One, Xbox 360 y Xbox original.<br>
          • Modo de inicio rápido y Quick Resume para alternar entre juegos.<br>
          • Conectividad: Wi-Fi, HDMI 2.1, USB y almacenamiento expandible.<br>
          • Color: Blanco mate • Marca: <strong>XBOX</strong>.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 2-4 días hábiles • <strong>Garantía:</strong> 1 año oficial.
        </div>
      </div>
    </div>
  </div>
