<?php
// producto-headset-razer-kraken-v4-x-minecraft.php - versión individual con precio final $99.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Headset USB Razer Kraken V4 X RGB Minecraft PC</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/bC4XOSoxsK4X0nOhxA3YpWmk07eOaW7ObPEpJMdI.png" alt="Headset USB Razer Kraken V4 X RGB Minecraft PC">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorio • Razer • Novedades</div>
        <h1 id="prodTitle">Headset USB Razer Kraken V4 X RGB Minecraft PC</h1>
        <div class="price" id="prodPrice">$99.95</div>

        <div class="desc" id="prodDesc">
          • Diseño temático Minecraft con iluminación RGB personalizable.<br>
          • Conexión USB para PC, con compatibilidad plug-and-play.<br>
          • Sonido envolvente estéreo optimizado para juegos y multimedia.<br>
          • Almohadillas suaves y diadema ajustable para largas sesiones.<br>
          • Micrófono retráctil con cancelación de ruido.<br>
          • Ligero y cómodo, ideal para gamers jóvenes y fans de Minecraft.<br>
          • Compatible con software Razer Synapse para personalización avanzada.
        </div>
