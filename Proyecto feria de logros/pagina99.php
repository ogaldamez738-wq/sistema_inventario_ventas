<?php
// producto-motherboard-asus-tuf-b850m-plus-am5.php - versión individual con precio final $299.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Motherboard ASUS TUF B850M-PLUS WiFi AM5 DDR5</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/r3Iymbj1mielO33smqxlg0fc2Ku8fEBQkcoJlVUZ.png" alt="Motherboard ASUS TUF B850M-PLUS WiFi AM5 DDR5">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Motherboard • ASUS • Zona Gamer</div>
        <h1 id="prodTitle">Motherboard ASUS TUF B850M-PLUS WiFi AM5 DDR5</h1>
        <div class="price" id="prodPrice">$299.00</div>

        <div class="desc" id="prodDesc">
          • Soporte para procesadores AMD Socket AM5 de última generación.<br>
          • Memoria DDR5 con overclocking estable y capacidad de hasta 128 GB.<br>
          • Conectividad WiFi 6 y LAN 2.5Gb para redes rápidas y estables.<br>
          • Diseño TUF Gaming con disipadores mejorados para estabilidad térmica.<br>
          • Compatibilidad con tarjetas gráficas modernas y múltiples puertos PCIe 5.0.<br>
          • Audio mejorado con condensadores de alta calidad y protección EMI.<br>
          • BIOS fácil de usar y software Armoury Crate para control completo del sistema.
        </div>
