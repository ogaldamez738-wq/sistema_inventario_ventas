<?php 
// producto-usb-kingston-exodia.php - versión individual con precio final $69.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - USB Kingston DataTraveler Exodia 128GB USB 3.2</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.rafenlinea.com/368-large_default/memoria-usb-kingston-128gb-32.jpg">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Almacenamiento • Kingston • Novedades</div>
        <h1 id="prodTitle">USB Kingston DataTraveler Exodia 128GB USB 3.2</h1>
        <div class="price" id="prodPrice">$14.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 128GB USB 3.2.<br>
          • Transferencia rápida de datos entre dispositivos.<br>
          • Diseño con tapa protectora y gancho para llavero.<br>
          • Compatible con PC, laptops, televisores y consolas.<br>
          • Ideal para guardar documentos, fotos, videos y música.<br>
          • Marca: Kingston DataTraveler Exodia.
        </div>
