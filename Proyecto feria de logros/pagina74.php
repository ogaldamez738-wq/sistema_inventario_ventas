<?php
// producto-bascula-xiaomi.php - Página individual de la Báscula Inteligente Mi Scale 2
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Báscula Inteligente Mi Scale 2</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSMF_Y4N2imMd8ADD3jPsqId8eP4JIpj7355A&s" alt="Báscula Inteligente Mi Scale 2">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Báscula • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Báscula Inteligente Mi Scale 2</h1>
        <div class="price" id="prodPrice">$34.99</div>

        <div class="desc" id="prodDesc">
          • Monitorea peso, IMC y composición corporal.<br>
          • Sincronización con la app Mi Fit.<br>
          • Compatible con múltiples usuarios.<br>
          • Diseño moderno y delgado, fácil de almacenar.
        </div>
