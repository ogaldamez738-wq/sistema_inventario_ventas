<?php
// producto-ram-kingston-fury-renegade.php - versión individual con precio final $169.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Memoria RAM Kingston Fury Renegade DDR5 32GB 6000MHz</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://cyccomputer.pe/51650-home_default/memoria-32gb-ddr5-kingston-fury-renegade-rgb-bus-6000mhz-pnkf560c32rsa-32.jpg">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Memoria RAM • Kingston • Novedades</div>
        <h1 id="prodTitle">Memoria RAM Kingston Fury Renegade DDR5 32GB 6000MHz</h1>
        <div class="price" id="prodPrice">$169.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 32GB DDR5.<br>
          • Frecuencia: 6000MHz para rendimiento extremo.<br>
          • Latencia CL36 optimizada para gaming y overclock.<br>
          • Disipador de calor de aluminio de alto rendimiento.<br>
          • Compatible con Intel XMP 3.0 y plataformas AMD DDR5.<br>
          • Ideal para gamers, creadores de contenido y entusiastas.<br>
          • Marca: Kingston Fury Renegade.
        </div>
