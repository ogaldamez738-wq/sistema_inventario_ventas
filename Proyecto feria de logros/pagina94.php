<?php
// producto-razer-leviathan-v2-rgb.php - versión individual con precio final $259.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Sistema de audio Razer Leviathan V2 RGB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada648b5ca8d335b.jpg" alt="Sistema de audio Razer Leviathan V2 RGB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Audio • Razer • Novedades</div>
        <h1 id="prodTitle">Sistema de audio Razer Leviathan V2 RGB</h1>
        <div class="price" id="prodPrice">$259.00</div>

        <div class="desc" id="prodDesc">
          • Barra de sonido premium con subwoofer inalámbrico integrado.<br>
          • Sonido THX Spatial Audio para una experiencia envolvente 360°.<br>
          • Iluminación RGB Chroma personalizable con más de 16.8 millones de colores.<br>
          • Conectividad Bluetooth 5.2 y USB tipo C para PC, consolas y móviles.<br>
          • Diseño elegante y compacto ideal para escritorios gamers o estaciones multimedia.<br>
          • Controles táctiles de volumen y efectos integrados en la barra.<br>
          • Compatible con Razer Synapse para ajustes avanzados de audio y luz.
        </div>
