<?php
// producto-base-ventilacion.php - Base de ventilación para laptop Nova FHC78800
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Base de Ventilación para Laptop</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e140ac15b55.jpg" alt="Base de Ventilación para Laptop">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Base de ventilación • Nova FHC78800 • Zona Cómputo</div>
        <h1 id="prodTitle">Base de Ventilación para Laptop Nova FHC78800</h1>
        <div class="price" id="prodPrice">$14.85</div>

        <div class="desc" id="prodDesc">
          Base de ventilación para laptops de hasta 15.6 pulgadas, modelo Nova FHC78800. Diseño ergonómico que mejora la circulación del aire,
          reduce la temperatura del equipo y permite sesiones prolongadas de uso sin sobrecalentamiento. Compatible con laptops de diferentes marcas y cuenta con soporte ajustable.
        </div>

        <ul class="puntos">
          <li>Compatible con laptops hasta 15.6 pulgadas</li>
          <li>Ergonómica y ajustable</li>
          <li>Reduce temperatura y protege tu equipo</li>
          <li>Construcción ligera y portátil</li>
          <li>Ideal para uso diario en oficina o gaming</li>
        </ul>
