<?php
// producto-laptop-asus-rog-strix.php - versión individual con precio final $2299.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Laptop ASUS ROG Strix</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/v7lCIfcJkGmCSqVdbSSIAslkPKDlmOtbK9LmlHas.png" alt="Laptop ASUS ROG Strix">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • ASUS • Zona Gamer</div>
        <h1 id="prodTitle">Laptop ASUS ROG Strix</h1>
        <div class="price" id="prodPrice">$2299.95</div>

        <div class="desc" id="prodDesc">
          • Potente procesador Intel Core i9 de 13ª generación.<br>
          • Tarjeta gráfica NVIDIA GeForce RTX 4070 para un rendimiento extremo en juegos.<br>
          • Pantalla QHD de 17" con 240 Hz para una experiencia fluida y detallada.<br>
          • Sistema de refrigeración inteligente con tecnología ROG Intelligent Cooling.<br>
          • Teclado RGB personalizable y chasis con diseño gamer premium.<br>
          • Almacenamiento SSD NVMe de 1 TB y 32 GB de RAM DDR5.<br>
          • Conectividad Wi-Fi 6E y múltiples puertos de expansión.
        </div>
