<?php
// producto-redmi-buds-4-pro.php - Página individual de los Auriculares Redmi Buds 4 Pro
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Auriculares Redmi Buds 4 Pro</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqeFQyK0Cb2Jv8tUb21uLD-N6dIBXUHBc4Tw&s" alt="Auriculares Redmi Buds 4 Pro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Auriculares • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Redmi Buds 4 Pro</h1>
        <div class="price" id="prodPrice">$69.99</div>

        <div class="desc" id="prodDesc">
          • True Wireless con cancelación activa de ruido ANC.<br>
          • Sonido de alta fidelidad con drivers dinámicos de 11 mm.<br>
          • Conexión Bluetooth 5.3 y baja latencia para gaming y video.<br>
          • Hasta 36 horas de reproducción con estuche de carga.<br>
          • Control táctil y resistencia IP54 contra agua y sudor.<br>
          • Compatible con asistentes de voz y carga rápida USB-C.
        </div>
