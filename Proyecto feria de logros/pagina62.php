<?php
// producto-msi-vector16.php - versión limpia con precio final $3699.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop MSI Vector 16 AI A2XWIG</title>
  <style>
    /* --- estilos idénticos al ejemplo --- */
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/26A7j49bYOf2lcwJXZIvnLyyDxoex4PlsXkgjGen.png" alt="Laptop MSI Vector 16 AI A2XWIG">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • MSI • Zona gamer</div>
        <h1 id="prodTitle">Laptop MSI Vector 16 AI A2XWIG</h1>
        <div class="price" id="prodPrice">$3699.95</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Ultra 9 275HX.<br>
          • RAM DDR5 16GB, multitarea avanzada.<br>
          • SSD de 1TB para almacenamiento rápido.<br>
          • NVIDIA RTX 5080 16GB, ideal para gaming AAA y renderizado.<br>
          • Pantalla QHD IPS 16” 240Hz, colores precisos y alta fluidez.<br>
          • Windows 11 Home preinstalado, acabado Cosmo Grey, teclado US.
        </div>
