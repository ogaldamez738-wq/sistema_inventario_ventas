<?php
// producto-ssd-kingston-nv2.php - versión individual con precio final $69.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - SSD Kingston NV2 NVMe PCIe 1TB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://llego.com.gt/wp-content/uploads/ktc-product-ssd-snv2s-1000g-3-zm-lg.jpg">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Almacenamiento • Kingston • Novedades</div>
        <h1 id="prodTitle">SSD Kingston NV2 NVMe PCIe 1TB</h1>
        <div class="price" id="prodPrice">$69.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 1TB NVMe PCIe 4.0.<br>
          • Velocidad de lectura: hasta 3,500 MB/s.<br>
          • Velocidad de escritura: hasta 2,100 MB/s.<br>
          • Ideal para laptops y PCs de alto rendimiento.<br>
          • Diseño M.2 2280 compacto y eficiente.<br>
          • Marca: Kingston NV2.
        </div>
