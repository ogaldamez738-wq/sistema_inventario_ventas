<?php
// producto-tinta-epson-t49m120.php - Botella de tinta Epson T49M120 Negro
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Botella de tinta Epson T49M120 Negro</title>
  <style>
    /* ------- CSS completo de la plantilla base ------- */
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada650a108c0d427.jpg" alt="Botella de tinta Epson T49M120 Negro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Epson • T49M120 • Zona Home Office</div>
        <h1 id="prodTitle">Botella de tinta Epson T49M120 Negro 140ml</h1>
        <div class="price" id="prodPrice">$19.20</div>
        <div class="desc" id="prodDesc">
          Botella de tinta negra Epson T49M120 de 140ml, compatible con impresoras SC-F570, F571 y F170. Ideal para impresión continua y de alta calidad.
        </div>
        <ul class="puntos">
          <li>Tinta negra de alta concentración</li>
          <li>Compatible con modelos Epson SC-F570, F571 y F170</li>
          <li>Volumen de 140ml para impresión prolongada</li>
          <li>Alta durabilidad y calidad de impresión</li>
        </ul>
        <div class="options">
          <div class="qty">
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 6 meses.
        </div>
      </div>
    </div>
  </div>
