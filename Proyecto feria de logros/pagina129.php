<?php
// producto-teclado-redragon-inalambrico.php - versión individual con precio final $84.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado mecánico inalámbrico 2.4GHz Bluetooth Redragon</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/UnXS3MvjFPLkBAFPdzH04zavRGVQyubtvNwSEwoC.png" alt="Teclado mecánico inalámbrico 2.4GHz Bluetooth Redragon">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Periférico • Redragon • Novedades</div>
        <h1 id="prodTitle">Teclado mecánico inalámbrico 2.4GHz Bluetooth Redragon</h1>
        <div class="price" id="prodPrice">$84.95</div>

        <div class="desc" id="prodDesc">
          • Teclado mecánico inalámbrico con conectividad dual: 2.4GHz y Bluetooth 5.0.<br>
          • Switches mecánicos Redragon de alta durabilidad.<br>
          • Retroiluminación RGB personalizable con múltiples efectos.<br>
          • Diseño compacto y portátil con estructura metálica reforzada.<br>
          • Batería recargable de larga duración con cable USB-C.<br>
          • Compatible con Windows, macOS, Android e iOS.<br>
          • Modo de baja latencia ideal para juegos.<br>
          • Marca: <strong>REDRAGON</strong>.
        </div>
