<?php
// producto-impresora-epson-l14150.php - Impresora Epson Ecotank L14150
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Impresora Epson Ecotank L14150</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada661815793ab50.jpg" alt="Impresora Epson Ecotank L14150">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Epson • L14150 • Zona Home Office</div>
        <h1 id="prodTitle">Impresora Multifuncional Epson Ecotank L14150</h1>
        <div class="price" id="prodPrice">$699.99</div>
        <div class="desc" id="prodDesc">
          Impresora multifuncional Epson Ecotank L14150 con formato A3, conexión WiFi y sistema EcoTank para un rendimiento profesional.
        </div>
        <ul class="puntos">
          <li>Impresión, escaneo y copiado A3 y A4</li>
          <li>Conectividad WiFi y USB</li>
          <li>Tanque de tinta recargable EcoTank de alta capacidad</li>
          <li>Rendimiento eficiente para oficina y hogar</li>
          <li>Diseño compacto y profesional</li>
        </ul>
        <div class="options">
          <div class="qty">
