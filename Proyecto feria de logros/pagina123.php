<?php
// producto-teclado-corsair-k70.php - versión individual con precio final $159.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado mecánico Corsair K70 RGB MK.2</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://m.media-amazon.com/images/I/716-o5oFSjL.UF894,1000_QL80.jpg" alt="Teclado mecánico Corsair K70 RGB MK.2">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Teclado mecánico • Corsair • Novedades</div>
        <h1 id="prodTitle">Teclado mecánico Corsair K70 RGB MK.2</h1>
        <div class="price" id="prodPrice">$159.99</div>

        <div class="desc" id="prodDesc">
          • Switches mecánicos de alta durabilidad.<br>
          • Iluminación RGB personalizable por tecla.<br>
          • Estructura de aluminio anodizado para mayor resistencia.<br>
          • Teclas multimedia dedicadas y reposamuñecas desmontable.<br>
          • Compatible con software iCUE para personalización avanzada.<br>
          • Anti-ghosting y N-Key rollover para gaming profesional.<br>
          • Marca: Corsair.
        </div>
