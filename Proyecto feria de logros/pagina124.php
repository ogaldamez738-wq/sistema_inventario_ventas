<?php
// producto-mouse-corsair-dark-core.php - versión individual con precio final $79.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Mouse gaming Corsair Dark Core RGB Pro</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://m.media-amazon.com/images/I/61cv5aWlTTL.UF894,1000_QL80.jpg" alt="Mouse gaming Corsair Dark Core RGB Pro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Mouse • Corsair • Novedades</div>
        <h1 id="prodTitle">Mouse gaming Corsair Dark Core RGB Pro</h1>
        <div class="price" id="prodPrice">$79.99</div>

        <div class="desc" id="prodDesc">
          • Sensor óptico de alta precisión de 18.000 DPI.<br>
          • Conectividad inalámbrica SLIPSTREAM CORSAIR o Bluetooth.<br>
          • Iluminación RGB personalizable por zona.<br>
          • Forma ergonómica para largas sesiones de juego.<br>
          • Botones laterales programables y superficie de agarre antideslizante.<br>
          • Compatible con software iCUE para macros y personalización.<br>
          • Marca: Corsair.
        </div>
