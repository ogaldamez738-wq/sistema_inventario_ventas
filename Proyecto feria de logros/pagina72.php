<?php
// producto-cargador-xiaomi.php - Página individual del Cargador Inalámbrico 30W
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cargador Inalámbrico 30W</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://http2.mlstatic.com/D_NQ_NP_794978-MPE92312705782_092025-O.webp" alt="Cargador Inalámbrico 30W">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Cargador • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Cargador Inalámbrico 30W</h1>
        <div class="price" id="prodPrice">$29.99</div>

        <div class="desc" id="prodDesc">
          • Carga rápida inalámbrica hasta 30W.<br>
          • Compatible con smartphones Xiaomi y otros Qi.<br>
          • Diseño compacto y seguro con protección contra sobrecarga.<br>
          • Superficie antideslizante para estabilidad del dispositivo.
        </div>
