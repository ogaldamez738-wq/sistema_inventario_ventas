<?php
// producto-tarjeta-msi-ventus-3x-rtx5080.php - versión individual con precio final $1599.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Tarjeta de video MSI Ventus 3X RTX 5080 16GB GDDR7 OCE</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/O9R3bFm2Y4oJKtTPf2ImC2oH1eDLUD6puCAtTAsJ.png" alt="Tarjeta de video MSI Ventus 3X RTX 5080 16GB GDDR7 OCE">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Tarjeta gráfica • MSI • Novedades</div>
        <h1 id="prodTitle">Tarjeta de video MSI Ventus 3X RTX 5080 16GB GDDR7 OCE G5080-16VCW Blanco</h1>
        <div class="price" id="prodPrice">$1599.00</div>

        <div class="desc" id="prodDesc">
          • GPU NVIDIA GeForce RTX 5080 con arquitectura Ada Lovelace.<br>
          • 16GB de memoria GDDR7 ultra rápida.<br>
          • Diseño MSI Ventus 3X con triple ventilador TORX 5.0 para máxima refrigeración.<br>
          • Edición OCE (Overclock Edition) para rendimiento superior.<br>
          • Backplate metálico blanco premium para mayor rigidez.<br>
          • Soporte para Ray Tracing y DLSS 3.5.<br>
          • Interfaz PCI Express 5.0.<br>
          • Compatible con resoluciones 4K y 8K.<br>
          • Ideal para gaming extremo y creación de contenido profesional.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 3 años.
        </div>
      </div>
    </div>
  </div>
