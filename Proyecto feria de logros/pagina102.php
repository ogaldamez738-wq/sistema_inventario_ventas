<?php
// producto-ram-kingston-fury-beast.php - versión individual con precio final $49.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://techzone.com.sv/wp-content/uploads/2023/07/Diapositiva1-156.jpg">
    </div>
    ...
    <div class="product-info">
      <div>
        ...
        <div class="desc" id="prodDesc">
          ...
          • Frecuencia: 3200MHz para un rendimiento superior.<br>
          • Diseñada para gamers y entusiastas del alto rendimiento.<br>
          • Disipador de calor negro elegante para mejor refrigeración.<br>
          • Compatible con Intel XMP y AMD Ryzen.<br>
          • Marca: Kingston Fury.
        </div>
