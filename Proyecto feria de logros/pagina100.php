<?php
// producto-laptop-asus-vivobook-e1504ga-i3.php - versión individual con precio final $549.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Laptop ASUS VivoBook E1504GA-WB31 Proc. Intel Core i3</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/ysnQhYt09mWAUBLO9QVpndDHbdTHYAmbjtLQmG0P.png" alt="Laptop ASUS VivoBook E1504GA-WB31 Proc. Intel Core i3">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • ASUS • Zona Tecnología</div>
        <h1 id="prodTitle">Laptop ASUS VivoBook E1504GA-WB31 Proc. Intel Core i3</h1>
        <div class="price" id="prodPrice">$549.00</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Core i3 de 12ª generación para rendimiento eficiente en tareas diarias.<br>
          • Pantalla de 15.6” Full HD con colores nítidos y buen ángulo de visión.<br>
          • Memoria RAM de 8GB DDR4 y almacenamiento SSD de 512GB para rapidez en carga de programas.<br>
          • Diseño ligero y delgado ideal para movilidad y trabajo remoto.<br>
          • Conectividad WiFi 6, Bluetooth 5.2 y puertos USB-C, USB 3.2 y HDMI.<br>
          • Teclado cómodo con diseño ergonómico y touchpad de precisión.<br>
          • Batería de larga duración para todo el día y sistema operativo Windows 11 Home preinstalado.
        </div>
