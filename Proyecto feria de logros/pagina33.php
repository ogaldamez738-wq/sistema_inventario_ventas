<?php
// producto-camara-solar.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cámara de Videovigilancia Solar</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68ead4942ae77.jpg" alt="Cámara de videovigilancia solar">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Cámara • Inalámbrica Solar</div>
        <h1 id="prodTitle">Cámara de Videovigilancia Inalámbrica Solar IPC-Q911</h1>
        <div class="price" id="prodPrice">$52.70</div>

        <div class="desc" id="prodDesc">
          • Cámara solar inalámbrica de alta eficiencia.<br>
          • Modelo IPC-Q911 con visión nocturna.<br>
          • Sensor HD y detección de movimiento.<br>
          • Compatible con conexión WiFi y energía solar.<br>
          • Ideal para exteriores y seguridad perimetral.
        </div>
