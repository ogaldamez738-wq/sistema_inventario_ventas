<?php
// producto-teclado-razer-blackwidow-v4.php - versión individual con precio final $159.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado Mecánico USB Razer BlackWidow V4 75%</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/4kxaeHC0FGIyPTfC7LZ7uR3zxpgbjaiaXzPRT1xI.png" alt="Teclado Mecánico USB Razer BlackWidow V4 75%">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorio • Razer • Novedades</div>
        <h1 id="prodTitle">Teclado Mecánico USB Razer BlackWidow V4 75%</h1>
        <div class="price" id="prodPrice">$159.95</div>

        <div class="desc" id="prodDesc">
          • Diseño compacto 75% ideal para escritorios pequeños.<br>
          • Teclas mecánicas Razer Green para respuesta táctil y sonora.<br>
          • Iluminación RGB personalizable con Razer Chroma.<br>
          • Estructura robusta con reposamuñecas desmontable.<br>
          • Conexión USB confiable y rápida, sin retrasos.<br>
          • Perfecto para gaming competitivo y escritura precisa.<br>
          • Funciones multimedia y teclas programables para mayor productividad.
        </div>
