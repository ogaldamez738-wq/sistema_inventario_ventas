<?php
// producto-hp-omnibook.php - Igual que los anteriores, solo cambia la info del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop HP Omnibook</title>
  <style>
    body {
      margin: 0;
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/TFlDDQ1CaLNXRbpcNntZYYLVf2PVYSQaBqz7wNCj.png" alt="Laptop HP Omnibook">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • HP • Ultra 5</div>
        <h1 id="prodTitle">Laptop HP Omnibook 14-fp0013dx</h1>
        <div class="price" id="prodPrice">$800</div>

        <div class="desc" id="prodDesc">
          Laptop HP Omnibook 14-fp0013dx con procesador Intel Ultra 5 120U, RAM DDR5 8GB, SSD 512GB, 
          pantalla táctil IPS 2K de 14", Windows 11, modelo B5UJ3UA.
        </div>
