<?php
// producto-fire-tv.php - Amazon Fire TV Stick
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Amazon Fire TV Stick</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/ziItYsJwkffHSvdjllysy802jw95ZsqMrWX0K28c.png" alt="Amazon Fire TV Stick">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Streaming • Amazon • Fire TV Stick • Zona Electrónica</div>
        <h1 id="prodTitle">Amazon Fire TV Stick HD 1080p HDR con Alexa Control de Voz</h1>
        <div class="price" id="prodPrice">$36.99</div>
        <div class="desc" id="prodDesc">
          Convierte tu TV en un centro de entretenimiento con Fire TV Stick HD. Controla tus apps y contenido con voz gracias a Alexa y disfruta de streaming en 1080p con HDR.
        </div>
        <ul class="puntos">
          <li>Streaming Full HD 1080p con soporte HDR</li>
          <li>Control por voz con Alexa incluido</li>
          <li>Compatible con apps populares: Netflix, Prime Video, YouTube</li>
          <li>Fácil instalación en cualquier TV con HDMI</li>
