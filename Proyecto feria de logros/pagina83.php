<?php
// producto-cable-hdmi.php - versión individual del Cable HDMI 4K UltraHD 2.0 de 3 metros
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Cable HDMI 4K UltraHD 2.0 de 3m</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68ee7d82e666c.jpg" alt="Cable HDMI 4K UltraHD 2.0 de 3 metros">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorio • HDMI • Conectividad</div>
        <h1 id="prodTitle">Cable HDMI 4K UltraHD 2.0 de 3 metros</h1>
        <div class="price" id="prodPrice">$12.99</div>

        <div class="desc" id="prodDesc">
          • Cable HDMI 2.0 compatible con resoluciones hasta 4K @60Hz.<br>
          • Longitud: 3 metros, ideal para televisores, monitores o proyectores.<br>
          • Soporte para HDR, ARC y transmisión de audio multicanal.<br>
          • Conectores chapados en oro para mejor conductividad.<br>
          • Material trenzado resistente para mayor durabilidad.<br>
          • Compatible con consolas, laptops, PCs y Smart TVs.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 2-4 días hábiles • <strong>Garantía:</strong> 1 año.
        </div>
      </div>
    </div>
  </div>
