<?php
// producto-motherboard-gigabyte-z890.php - versión individual
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Motherboard Gigabyte Z890 Eagle LGA1851 DDR5 WiFi 7</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68f0284ddba10.jpg" alt="Motherboard Gigabyte Z890 Eagle LGA1851 DDR5 WiFi 7">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Placa Madre • GIGABYTE • Tecnología DDR5</div>
        <h1 id="prodTitle">Motherboard Gigabyte Z890 Eagle LGA1851 DDR5 WiFi 7</h1>
        <div class="price" id="prodPrice">$329.95</div>

        <div class="desc" id="prodDesc">
          • Socket LGA1851 compatible con procesadores Intel de 14ª generación.<br>
          • Soporte para memoria DDR5 de alta velocidad.<br>
          • Conectividad WiFi 7 y Ethernet 2.5G.<br>
          • Múltiples puertos M.2 PCIe 4.0 para SSD ultrarrápidos.<br>
          • VRM digital de alto rendimiento y refrigeración avanzada.<br>
          • Ideal para gaming y entornos de trabajo exigentes.
        </div>
