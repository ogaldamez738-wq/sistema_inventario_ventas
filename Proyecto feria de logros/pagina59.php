<?php
// producto-acer-predator.php - versión limpia con precio final $2699.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop Acer Predator Helio Neo PHN16S</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/Z4EH1gPZ0QIXE05GvLeUYPPKUvn3VtPes8nLWqdC.png" alt="Laptop Acer Predator Helio Neo PHN16S">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • Acer • Zona gamer</div>
        <h1 id="prodTitle">Laptop Acer Predator Helio Neo PHN16S</h1>
        <div class="price" id="prodPrice">$2699.95</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Ultra 9 275HX.<br>
          • RAM DDR5 32GB para multitarea extrema.<br>
          • SSD de 1TB para almacenamiento rápido.<br>
          • NVIDIA RTX 5070 Ti 12GB para gaming de alto nivel.<br>
          • Pantalla OLED 16” 240Hz, colores vivos y fluidos.<br>
          • Teclado US, diseño moderno y acabado negro.<br>
