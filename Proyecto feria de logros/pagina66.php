<?php
// producto-redmi-note-14-pro.php - versión individual con precio final $389.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Redmi Note 14 Pro</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQxYGuAQmptp0vj8D1wcEhsa25h_rh1LO4tZQ&s" alt="Redmi Note 14 Pro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Smartphone • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Redmi Note 14 Pro</h1>
        <div class="price" id="prodPrice">$389.00</div>

        <div class="desc" id="prodDesc">
          • Pantalla AMOLED 120Hz de 6.67" con resolución Full HD+.<br>
          • Procesador Snapdragon 7s Gen 2 de alto rendimiento.<br>
          • Cámara triple con sensor principal de 200MP.<br>
          • 8GB de RAM y 256GB de almacenamiento interno.<br>
          • Batería de 5000 mAh con carga rápida de 67W.<br>
          • Diseño premium con protección Gorilla Glass Victus.<br>
          • MIUI 15 basado en Android 14.
        </div>
