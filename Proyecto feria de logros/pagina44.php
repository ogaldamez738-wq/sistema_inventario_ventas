<?php
// producto-camara-fujifilm.php - Cámara instantánea Fujifilm Instax Mini 12
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cámara Fujifilm Instax Mini 12</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/hvksXbFbx3T6OdFZMo7xoDA9qSRGJVqWqJJdKpMZ.png" alt="Cámara Fujifilm Instax Mini 12">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Cámaras • Fujifilm • Instax Mini 12 • Zona Electrónica</div>
        <h1 id="prodTitle">Cámara instantánea Fujifilm Instax Mini 12 – Morado</h1>
        <div class="price" id="prodPrice">$140.50</div>
        <div class="desc" id="prodDesc">
          Captura y comparte momentos al instante con la Fujifilm Instax Mini 12. Diseño compacto y colorido ideal para selfies y fotografías espontáneas.
        </div>
        <ul class="puntos">
          <li>Fotografía instantánea con revelado al instante</li>
          <li>Diseño compacto y portátil</li>
          <li>Modo selfie con espejo incorporado</li>
          <li>Compatible con película Instax Mini</li>
          <li>Color morado vibrante y moderno</li>
        </ul>
        <div class="options">
          <div class="qty">
