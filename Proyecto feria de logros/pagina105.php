<?php
// producto-microsd-kingston-canvas-select-plus.php - versión individual con precio final $12.50
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Tarjeta microSD Kingston Canvas Select Plus 128GB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.rafenlinea.com/383-large_default/tarjeta-micro-sd-de-128gb-.jpg" alt="Tarjeta microSD Kingston Canvas Select Plus 128GB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Almacenamiento • Kingston • Novedades</div>
        <h1 id="prodTitle">Tarjeta microSD Kingston Canvas Select Plus 128GB</h1>
        <div class="price" id="prodPrice">$12.50</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 128GB microSDXC.<br>
          • Velocidades de lectura de hasta 100MB/s.<br>
          • Ideal para smartphones, cámaras y tabletas.<br>
          • Clasificación A1 para un rendimiento rápido en apps.<br>
          • Diseñada para resistir temperaturas, golpes y vibraciones.<br>
          • Incluye adaptador SD para mayor compatibilidad.<br>
          • Marca: Kingston.
        </div>
