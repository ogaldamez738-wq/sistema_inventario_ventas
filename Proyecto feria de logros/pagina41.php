<?php
// producto-bocina-google.php - Bocina Google Nest Mini
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Bocina Google Nest Mini</title>
  <style>
    /* ------- Copiar CSS completo de la plantilla base ------- */
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/qN81jkvsfQoW4YeLbPqpIDIscRSSnq4sLRXQzaEQ.png" alt="Bocina Google Nest Mini">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Bocina • Google • Nest Mini • Zona Electrónica</div>
        <h1 id="prodTitle">Bocina con asistente de voz Google Nest Mini GA00638-US</h1>
        <div class="price" id="prodPrice">$25.50</div>
        <div class="desc" id="prodDesc">
          Controla tu hogar inteligente, escucha música y obtén información rápidamente con la bocina Google Nest Mini. Compacta y potente, ideal para cualquier espacio.
        </div>
        <ul class="puntos">
          <li>Asistente de voz integrado para control inteligente</li>
          <li>Audio claro y potente a pesar de su tamaño compacto</li>
          <li>Compatible con otros dispositivos Google y smart home</li>
          <li>Fácil configuración y conectividad Wi-Fi</li>
          <li>Diseño moderno que se integra a cualquier ambiente</li>
        </ul>
        <div class="options">
          <div class="qty">
