<?php
// producto-combo-pc-gamer.php - versión individual
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Combo PC Gamer Ryzen 5 5600X + B550M + RTX</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/WPvAVq3yEebF7O7J58PNUgj5aZPoOOWsDz5fnSxt.png" alt="Combo PC Gamer Ryzen 5 5600X + B550M + RTX">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Gamer • AMD • Potencia</div>
        <h1 id="prodTitle">Combo PC Gamer Ryzen 5 5600X + B550M + RTX</h1>
        <div class="price" id="prodPrice">$999.95</div>

        <div class="desc" id="prodDesc">
          • Procesador AMD Ryzen 5 5600X de 6 núcleos y 12 hilos.<br>
          • Placa base B550M con soporte para PCIe 4.0.<br>
          • Tarjeta gráfica NVIDIA RTX (modelo configurable).<br>
          • Memoria RAM DDR4 de 16GB y SSD de 1TB.<br>
          • Fuente 650W certificada 80+ Bronze.<br>
        ...
        <div class="extra">
          <strong>Envío:</strong> 5-7 días hábiles • <strong>Garantía:</strong> 2 años.
        </div>
      </div>
    </div>
  </div>
