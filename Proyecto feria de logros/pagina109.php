<?php
// producto-logitech-g29.php - versión individual con precio final $325.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Kit timón y pedales Driving Force Logitech G29</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.logitechg.com/assets/66450/6/g29-driving-force-racing-wheel.jpg" alt="Kit timón y pedales Driving Force Logitech G29">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Logitech • Novedades</div>
        <h1 id="prodTitle">Kit timón y pedales Driving Force Logitech G29</h1>
        <div class="price" id="prodPrice">$325.00</div>

        <div class="desc" id="prodDesc">
          • Kit de timón y pedales profesional para simuladores de conducción.<br>
          • Compatible con PlayStation 4, PlayStation 5 y PC.<br>
          • Pedales de acelerador, freno y embrague metálicos de alta precisión.<br>
          • Force Feedback realista para una experiencia inmersiva.<br>
          • Giro de timón de 900° con rotación ajustable.<br>
          • Incluye soporte de sujeción estable para escritorio.<br>
          • Marca: Logitech.
        </div>
