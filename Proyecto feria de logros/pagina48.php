<?php
// producto-tripode-genius.php - Trípode Genius hasta 25cm
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Trípode Genius 25cm</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada67f186e32ce7d.jpg" alt="Trípode Genius hasta 25cm">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Genius • Trípode hasta 25cm • Zona Móvil</div>
        <h1 id="prodTitle">Trípode Genius hasta 25cm – Ideal para webcam</h1>
        <div class="price" id="prodPrice">$3.99</div>
        <div class="desc" id="prodDesc">
          Trípode Genius compacto y portátil, ideal para cámaras web y smartphones, con altura máxima de 25 cm y soporte estable.
        </div>
        <ul class="puntos">
          <li>Altura máxima: 25cm</li>
          <li>Compatibilidad con webcam y smartphones</li>
          <li>Diseño ligero y portátil</li>
          <li>Base estable para grabaciones y streaming</li>
        </ul>
        <div class="options">
          <div class="qty">
