<?php
// producto-camara-xiaomi.php - Página individual de la Cámara de Seguridad Mi 360°
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cámara de Seguridad Mi 360°</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://xiaomistore.com.sv/wp-content/uploads/MI-360-Home-Security-Camera-2K-Pro-5226-4.webp" alt="Cámara de Seguridad Mi 360°">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Cámara • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Cámara de Seguridad Mi 360°</h1>
        <div class="price" id="prodPrice">$49.99</div>

        <div class="desc" id="prodDesc">
          • Resolución 2K para imágenes nítidas.<br>
          • Visión nocturna y detección de movimiento.<br>
          • Audio bidireccional para comunicación remota.<br>
          • Compatible con Mi Home App.<br>
          • Rotación 360° para cobertura completa del hogar.
        </div>
