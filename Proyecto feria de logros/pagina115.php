<?php
// producto-hp-240-g9-i5.php - versión individual con precio final $579.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Laptop HP 240 G9 Intel Core i5 12va Gen 8GB 512GB SSD</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://alfatechperu.com/wp-content/uploads/2024/08/laptop-hp-240-g9-intel-core-i5-1235u-8gb-ram-512gb-ssd-14-hd-led.webp" alt="Laptop HP 240 G9 Intel Core i5 12va Gen 8GB 512GB SSD">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • HP • Novedades</div>
        <h1 id="prodTitle">Laptop HP 240 G9 Intel Core i5 12va Gen 8GB 512GB SSD</h1>
        <div class="price" id="prodPrice">$579.99</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Core i5 de 12va generación.<br>
          • Memoria RAM: 8GB DDR4.<br>
          • Almacenamiento: 512GB SSD para mayor velocidad.<br>
          • Pantalla HD de 14 pulgadas con colores nítidos.<br>
          • Conectividad completa: HDMI, USB-C, Wi-Fi y Bluetooth.<br>
