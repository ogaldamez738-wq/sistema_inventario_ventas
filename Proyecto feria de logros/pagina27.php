<?php
// producto-motherboard-gigabyte.php - Motherboard Gigabyte Z890
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Motherboard Gigabyte Z890</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68f0284ddba10.jpg" alt="Motherboard Gigabyte Z890">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Motherboard • Gigabyte • Z890 • Zona Hardware</div>
        <h1 id="prodTitle">Motherboard Gigabyte Z890 Eagle LGA1851 DDR5</h1>
        <div class="price" id="prodPrice">$240</div>

        <div class="desc" id="prodDesc">
          Motherboard Gigabyte Z890 Eagle con soporte LGA1851, memoria DDR5, WiFi 7 y Bluetooth 5.4. Ideal para configuraciones de alto rendimiento.
        </div>

        <ul class="puntos">
          <li>4 ranuras DDR5 para máximo rendimiento</li>
          <li>WiFi 7 y Bluetooth 5.4 integrados</li>
          <li>Diseño Eagle robusto y estable</li>
          <li>Compatibilidad con múltiples tarjetas y periféricos</li>
        </ul>
