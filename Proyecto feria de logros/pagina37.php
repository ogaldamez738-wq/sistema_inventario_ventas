<?php
// producto-cable-ugreen.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cable de red Ugreen Cat8</title>
  <style>
    /* --- mismos estilos base --- */
    body {
      margin: 0;
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada685581a07af12.jpg" alt="Cable Ugreen Cat8">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Cables • Ugreen</div>
        <h1 id="prodTitle">Cable de Red UTP Ugreen Cat8 3mts 30AWG</h1>
        <div class="price" id="prodPrice">$5.20</div>

        <div class="desc" id="prodDesc">
          • Cable UTP categoría 8 de alta velocidad.<br>
          • Longitud de 3 metros, calibre 30AWG.<br>
          • Transmisión hasta 40Gbps y 2000MHz.<br>
          • Ideal para redes domésticas y profesionales.<br>
          • Revestimiento resistente y conectores RJ45 dorados.<br>
          • Modelo: Ugreen 80432.
        </div>
