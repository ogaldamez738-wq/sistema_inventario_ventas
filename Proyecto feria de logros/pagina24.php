<?php
// producto-disco-seagate.php - Disco duro externo Seagate 20TB
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Disco Duro Externo Seagate 20TB</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/F1rX5oZonX6raAf3GnLGEfjpU86cboBkDO7zU1Vc.png" alt="Disco Duro Externo Seagate 20TB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Disco duro externo • Seagate • 20TB • Zona Cómputo</div>
        <h1 id="prodTitle">Disco Duro Externo Seagate 20TB Expansion STKP20000400</h1>
        <div class="price" id="prodPrice">$300</div>

        <div class="desc" id="prodDesc">
          Disco duro externo Seagate 20TB modelo Expansion STKP20000400 para escritorio. Alta capacidad para almacenamiento masivo de datos,
          copias de seguridad y archivos multimedia. Diseño compacto, fácil de instalar y compatible con Windows y Mac.
        </div>

        <ul class="puntos">
          <li>Capacidad de 20TB para almacenamiento masivo</li>
          <li>Conexión USB 3.0 para transferencia rápida</li>
          <li>Compatible con Windows y Mac</li>
          <li>Ideal para copias de seguridad y archivos multimedia</li>
          <li>Diseño robusto y confiable para uso diario</li>
        </ul>
