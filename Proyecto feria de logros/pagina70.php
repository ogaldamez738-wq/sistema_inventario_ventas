<?php
// producto-powerbank-redmi.php - Página individual del Powerbank Redmi 20,000mAh Fast Charge
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Powerbank Redmi 20,000mAh Fast Charge</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ6KcP4dG7-6ncsEPpKLAFF-ay8IXRohtS-BA&s" alt="Powerbank Redmi 20,000mAh Fast Charge">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Powerbank • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Powerbank Redmi 20,000mAh Fast Charge</h1>
        <div class="price" id="prodPrice">$39.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad de 20,000mAh para múltiples cargas.<br>
          • Salida de carga rápida USB-C y USB-A.<br>
          • Diseño compacto y portátil.<br>
          • Compatible con smartphones, tablets y dispositivos USB.<br>
          • Protección múltiple contra sobrecarga y cortocircuitos.
        </div>
