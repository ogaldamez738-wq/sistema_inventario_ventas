<?php
// producto-mouse-hp-z3700.php - versión individual con precio final $24.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Mouse inalámbrico HP Z3700</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://siman.vtexassets.com/arquivos/ids/6387083/104793960_1.jpg?v=638865664192100000" alt="Mouse inalámbrico HP Z3700">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Mouse • HP • Novedades</div>
        <h1 id="prodTitle">Mouse inalámbrico HP Z3700</h1>
        <div class="price" id="prodPrice">$24.99</div>

        <div class="desc" id="prodDesc">
          • Tecnología inalámbrica 2.4 GHz con receptor USB.<br>
          • Diseño ergonómico y compacto.<br>
          • Funciona con Windows y Mac OS.<br>
          • Sensor óptico de alta precisión de 1000 dpi.<br>
          • Hasta 16 meses de duración de batería.<br>
          • Conexión Plug & Play, sin necesidad de software adicional.<br>
          • Marca: HP.
        </div>
