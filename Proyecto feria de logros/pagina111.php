<?php
// producto-logitech-g-pro.php - versión individual con precio final $129.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado mecánico Logitech G Pro</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/6BybRfyAhDGWiyaEWdosr3JyXYdPaY0RFGmwAUQP.png" alt="Teclado mecánico Logitech G Pro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Teclados • Logitech • Novedades</div>
        <h1 id="prodTitle">Teclado mecánico Logitech G Pro</h1>
        <div class="price" id="prodPrice">$129.95</div>

        <div class="desc" id="prodDesc">
          • Teclado mecánico compacto y profesional para gamers.<br>
          • Switches mecánicos GX Blue para respuesta rápida.<br>
          • Iluminación RGB personalizable por tecla.<br>
          • Diseño resistente y duradero para largas sesiones.<br>
          • Conectividad USB y software Logitech G HUB.<br>
          • Teclas anti-ghosting y N-Key rollover.<br>
          • Marca: Logitech.
        </div>
