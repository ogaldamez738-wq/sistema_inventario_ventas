<?php
// producto-logitech-g435.php - versión individual con precio final $74.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Headset inalámbricos BT Logitech G435</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/fAqCL931dZjxOBxWBa1bowYRl3dVI4pV5vCnxPHW.png" alt="Headset inalámbricos BT Logitech G435">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Auriculares • Logitech • Novedades</div>
        <h1 id="prodTitle">Headset inalámbricos BT Logitech G435</h1>
        <div class="price" id="prodPrice">$74.95</div>

        <div class="desc" id="prodDesc">
          • Auriculares inalámbricos ligeros con conectividad Bluetooth.<br>
          • Compatible con PC, PlayStation y dispositivos móviles.<br>
          • Audio envolvente y micrófono integrado con cancelación de ruido.<br>
          • Hasta 18 horas de duración de batería.<br>
          • Diseño cómodo y ajustable para sesiones largas.<br>
          • Incluye cable de carga USB-C.<br>
          • Marca: Logitech.
        </div>
