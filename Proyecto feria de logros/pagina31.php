<?php
// producto-pasta-corsair.php - Pasta térmica Corsair XTM70 3gr
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Pasta térmica Corsair XTM70 3gr</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68dd5d87ae834.jpg" alt="Pasta térmica Corsair XTM70">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Pasta térmica • Corsair • XTM70 • Zona Hardware</div>
        <h1 id="prodTitle">Pasta térmica Corsair XTM70 3gr CT-9010010-WW Extreme Performance</h1>
        <div class="price" id="prodPrice">$23</div>

        <div class="desc" id="prodDesc">
          Pasta térmica de alta conductividad Corsair XTM70 de 3 gramos, diseñada para maximizar la transferencia de calor entre el procesador y el disipador, ideal para overclocking y sistemas de alto rendimiento.
        </div>

        <ul class="puntos">
          <li>Alta conductividad térmica</li>
          <li>Fácil aplicación</li>
          <li>Ideal para overclocking</li>
          <li>Compatible con todos los disipadores modernos</li>
          <li>Presentación de 3 gramos suficiente para varias aplicaciones</li>
        </ul>
