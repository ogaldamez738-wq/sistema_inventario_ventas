<?php
// producto-logitech-mouse-pro-lol.php - versión individual con precio final $79.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Mouse inalámbrico Gamer Logitech Pro League of Legends</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.digitaloutlet.com.uy/imgs/productos/productos3_15288.png" alt="Mouse inalámbrico Gamer Logitech Pro League of Legends">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Mouse • Logitech • Novedades</div>
        <h1 id="prodTitle">Mouse inalámbrico Gamer Logitech Pro League of Legends</h1>
        <div class="price" id="prodPrice">$79.00</div>

        <div class="desc" id="prodDesc">
          • Mouse inalámbrico diseñado para gamers profesionales.<br>
          • Temática de League of Legends con iluminación personalizable.<br>
          • Sensor óptico de alta precisión para movimientos rápidos y exactos.<br>
          • Conectividad inalámbrica confiable y sin lag.<br>
          • Diseño ergonómico y cómodo para largas sesiones de juego.<br>
          • Marca: Logitech.
        </div>
