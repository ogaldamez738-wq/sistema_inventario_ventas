<?php
// producto-gpu-msi.php - Tarjeta de video MSI Gaming Trio RTX5090
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Tarjeta de video MSI Gaming Trio RTX5090</title>
  <style>
...
<header>
  ...
  <div class="icons">
    <a href="pagina9.php" title="pagina9.php"><span>🛒</span></a>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada67ae05ed8ae23.jpg" alt="Tarjeta de video MSI Gaming Trio RTX5090">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Tarjeta de video • MSI • Gaming Trio • Zona Hardware</div>
        <h1 id="prodTitle">Tarjeta de video MSI Gaming Trio RTX5090 32GB GDDR7 OCE G5090-32GTC</h1>
        <div class="price" id="prodPrice">$3600</div>

        <div class="desc" id="prodDesc">
          Tarjeta de video MSI Gaming Trio RTX5090 con 32GB GDDR7, tecnología OCE y refrigeración avanzada para gaming y creación de contenido profesional.
        </div>

        <ul class="puntos">
          <li>32GB de memoria GDDR7 ultra rápida</li>
          <li>Refrigeración avanzada Gaming Trio</li>
          <li>Overclock de fábrica OCE</li>
          <li>Compatible con ray tracing y DirectX 12 Ultimate</li>
          <li>Diseño robusto y silencioso para largas sesiones de juego</li>
        </ul>
