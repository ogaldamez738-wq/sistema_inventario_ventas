<?php
// producto-headset-razer-kraken-kitty.php - versión individual con precio final $99.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Headset Bluetooth Razer Kraken Kitty</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/c51445v58OZsAzccIiVmS9r3Ps6QDEy9bNlvmFIo.png" alt="Headset Bluetooth Razer Kraken Kitty">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona gamer • Razer • Novedades</div>
        <h1 id="prodTitle">Headset Bluetooth Razer Kraken Kitty</h1>
        <div class="price" id="prodPrice">$99.95</div>

        <div class="desc" id="prodDesc">
          • Auriculares inalámbricos con diseño icónico de orejas de gato.<br>
          • Iluminación RGB personalizable Razer Chroma.<br>
          • Sonido envolvente y micrófono retráctil con cancelación de ruido.<br>
          • Conectividad Bluetooth 5.0 y batería de larga duración.<br>
          • Almohadillas suaves para máxima comodidad en sesiones largas.<br>
          • Marca: Razer.
        </div>
