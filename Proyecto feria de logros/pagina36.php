<?php
// producto-camara-xiaomi.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cámara Xiaomi BW500</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68852339736d2.jpg" alt="Cámara Xiaomi BW500">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Cámaras • Xiaomi</div>
        <h1 id="prodTitle">Cámara de Videovigilancia WiFi Exteriores Xiaomi BW500 2.5K</h1>
        <div class="price" id="prodPrice">$69.99</div>

        <div class="desc" id="prodDesc">
          • Resolución 2.5K ultra nítida para mayor detalle.<br>
          • Batería recargable de 10,000 mAh de larga duración.<br>
          • Resistencia IP67 contra agua y polvo.<br>
          • Conectividad WiFi para fácil instalación sin cables.<br>
          • Visión nocturna y detección de movimiento inteligente.<br>
          • Modelo: BW500 (BHR8301GL).
        </div>
