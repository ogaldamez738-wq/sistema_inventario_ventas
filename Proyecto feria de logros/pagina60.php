<?php
// producto-msi-thin15.php - versión limpia con precio final $939.14
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop MSI Thin 15 B13VE-3023US</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/mBZalrq4s0tBZrdZamoTViANJC8bsb5fkpPgG1TM.png" alt="Laptop MSI Thin 15 B13VE-3023US">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • MSI • Zona gamer</div>
        <h1 id="prodTitle">Laptop MSI Thin 15 B13VE-3023US</h1>
        <div class="price" id="prodPrice">$939.14</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Core i5 13420H.<br>
          • RAM DDR4 16GB, rendimiento sólido para multitarea.<br>
          • SSD de 512GB para almacenamiento rápido.<br>
          • NVIDIA RTX 4050 6GB, gráficos adecuados para gaming ligero y multimedia.<br>
          • Pantalla IPS FHD 15.6” 144Hz.<br>
