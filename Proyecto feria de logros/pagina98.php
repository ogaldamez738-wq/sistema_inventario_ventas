<?php
// producto-case-asus-tuf-gt502.php - versión individual con precio final $279.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Case Midtower ASUS TUF GT502</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/fpXwdAhFmJr6cRS28z7HMxw5soD1ufl7VtnqALqK.png" alt="Case Midtower ASUS TUF GT502">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Case • ASUS • Zona Gamer</div>
        <h1 id="prodTitle">Case Midtower ASUS TUF GT502</h1>
        <div class="price" id="prodPrice">$279.00</div>

        <div class="desc" id="prodDesc">
          • Chasis Midtower con diseño TUF Gaming resistente y moderno.<br>
          • Soporta motherboards ATX, Micro-ATX y Mini-ITX.<br>
          • Panel lateral de vidrio templado para mostrar el interior del equipo.<br>
          • Incluye ventiladores ARGB preinstalados para una iluminación personalizada.<br>
          • Amplio espacio para refrigeración líquida y gestión de cables eficiente.<br>
          • Compatible con tarjetas gráficas de gran tamaño y múltiples unidades de almacenamiento.<br>
          • Puertos frontales USB 3.2, audio y controles de iluminación.
        </div>
