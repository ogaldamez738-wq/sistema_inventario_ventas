<?php
// producto-redmi-buds-5-pro.php - versión individual con precio final $129.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Redmi Buds 5 Pro</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT5phIpTzcoFHKeYPZGhjlpJjNP_dCsk2mKkw&s" alt="Redmi Buds 5 Pro">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Auriculares • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Redmi Buds 5 Pro</h1>
        <div class="price" id="prodPrice">$129.00</div>

        <div class="desc" id="prodDesc">
          • Audio Hi-Fi con cancelación de ruido activa (ANC) de hasta 52 dB.<br>
          • Conectividad Bluetooth 5.3 con emparejamiento rápido.<br>
          • Certificación Hi-Res Audio Wireless y códec LHDC 5.0.<br>
          • Hasta 10 horas de reproducción continua (38 h con estuche).<br>
          • Carga rápida USB-C y compatibilidad con carga inalámbrica.<br>
          • Diseño premium en cerámica con control táctil sensible.<br>
