<?php
// producto-estacion-carga.php - Estación de carga 7 en 1 Klip Xtreme KDC-700
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Estación de Carga 7 en 1</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/IcucnWbmuWuIrGbsi2uEMQVRqYwWOz7ZWWC2FazL.png" alt="Estación de carga 7 en 1">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Estación de carga • Klip Xtreme • KDC-700 • Zona Cómputo</div>
        <h1 id="prodTitle">Estación de carga 7 en 1 Klip Xtreme KDC-700</h1>
        <div class="price" id="prodPrice">$49.99</div>

        <div class="desc" id="prodDesc">
          Estación de carga 7 en 1 Klip Xtreme KDC-700 con 65W, incluye 2 puertos USB-C, 2 USB-A y 2 AC con pantalla digital. Ideal para cargar múltiples dispositivos simultáneamente.
        </div>

        <ul class="puntos">
          <li>Carga rápida de hasta 65W</li>
          <li>2 puertos USB-C y 2 puertos USB-A</li>
          <li>2 tomas AC para dispositivos adicionales</li>
          <li>Pantalla digital que muestra voltaje y carga</li>
          <li>Protección contra sobrecarga y cortocircuitos</li>
          <li>Diseño compacto y elegante para escritorio</li>
        </ul>
