<?php
// producto-bombillo-smart.php - Bombillo Smart Wi-Fi LED
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Bombillo Smart Wi-Fi LED</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/bqDkwX1zVDrOotbiZPaRvALCvC5ywf4YiFRICoIJ.png" alt="Bombillo Smart Wi-Fi LED">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Smart Home • TP-Link • Tapo L530E • Zona Electrónica</div>
        <h1 id="prodTitle">Bombillo Smart Wi-Fi LED TP-Link Tapo L530E – Pack 2 Unidades</h1>
        <div class="price" id="prodPrice">$12.20</div>
        <div class="desc" id="prodDesc">
          Ilumina tu hogar de manera inteligente con el bombillo TP-Link Tapo L530E. Controla encendido, apagado y colores desde tu smartphone o por voz.
        </div>
        <ul class="puntos">
          <li>Control remoto vía app Tapo o asistentes de voz</li>
          <li>Programaciones de encendido/apagado automáticas</li>
          <li>Compatible con Alexa y Google Assistant</li>
          <li>Luz LED eficiente de 800 lúmenes</li>
          <li>Incluye pack de 2 bombillos</li>
        </ul>
        <div class="options">
          <div class="qty">
