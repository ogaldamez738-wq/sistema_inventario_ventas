<?php
// producto_thinkbook.php - layout igual, solo datos del producto diferentes
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop Lenovo ThinkBook</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68dab4a947d32.jpg" alt="Laptop Lenovo ThinkBook">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • Lenovo • ThinkBook</div>
        <h1 id="prodTitle">Laptop Lenovo ThinkBook 14G6</h1>
        <div class="price" id="prodPrice">$749.99</div>

        <div class="desc" id="prodDesc">
          Laptop lenovo thinkbook 14g6 proc. intel core i7 13700h ram ddr5 8gb almacenamiento ssd 512gb pantalla ips fhd+ 14p w11pro 21kg00n6gj arctic grey
        </div>
