<?php
// producto-fuente-corsair-rm750x.php - versión individual con precio final $129.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Fuente de poder Corsair RM750x 750W 80 Plus Gold</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQIWmEET4nRNf6HHwzoJwczOyUkXKktEThaJw&s" alt="Fuente de poder Corsair RM750x 750W 80 Plus Gold">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Fuente de poder • Corsair • Novedades</div>
        <h1 id="prodTitle">Fuente de poder Corsair RM750x 750W 80 Plus Gold</h1>
        <div class="price" id="prodPrice">$129.99</div>

        <div class="desc" id="prodDesc">
          • Potencia: 750W para sistemas de alto rendimiento.<br>
          • Certificación 80 Plus Gold para eficiencia energética.<br>
          • Totalmente modular, facilitando la gestión de cables.<br>
          • Ventilador de 135mm con modo zero RPM para operación silenciosa.<br>
          • Componentes de alta calidad para estabilidad y durabilidad.<br>
          • Compatible con placas base ATX y gabinetes estándar.<br>
          • Marca: Corsair.
        </div>
