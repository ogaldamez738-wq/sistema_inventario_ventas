<?php
// producto-monitor-asus.php - Monitor ASUS TUF VG249Q3A FHD 23.8"
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Monitor ASUS TUF VG249Q3A</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/OrZjyYElOMal75AegC57aTOwDNVbNY0YmvMXFrcG.png" alt="Monitor ASUS TUF VG249Q3A">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Monitor • ASUS • TUF VG249Q3A • Zona Cómputo</div>
        <h1 id="prodTitle">Monitor ASUS TUF VG249Q3A FHD 23.8" 180Hz</h1>
        <div class="price" id="prodPrice">$120</div>

        <div class="desc" id="prodDesc">
          Monitor ASUS TUF VG249Q3A de 23.8 pulgadas con resolución FHD, tiempo de respuesta de 1ms, panel Fast IPS y frecuencia de actualización de 180Hz.
          Tecnología FreeSync para eliminar tearing y soporte HDMI/DP para conectividad flexible.
        </div>

        <ul class="puntos">
          <li>Resolución FHD 1920x1080</li>
          <li>Tiempo de respuesta 1ms Fast IPS</li>
          <li>Frecuencia de actualización de 180Hz</li>
          <li>Compatible con FreeSync</li>
          <li>Conexiones HDMI y DisplayPort</li>
          <li>Diseño ergonómico y ajuste de inclinación</li>
        </ul>
