<?php
// producto-router-cudy.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Router Cudy WR1300E AC1200</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e16f54e57ec.jpg" alt="Router Cudy WR1300E">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Router • Dualband</div>
        <h1 id="prodTitle">Router Multimode Dualband Cudy WR1300E AC1200 MU-MIMO RJ45 Gigabit</h1>
        <div class="price" id="prodPrice">$27.50</div>

        <div class="desc" id="prodDesc">
          • Router WiFi Dual Band AC1200 de alto rendimiento.<br>
          • Tecnología MU-MIMO para conexión simultánea estable.<br>
          • 4 antenas externas para mayor cobertura.<br>
          • Puertos RJ45 Gigabit para velocidad máxima.<br>
          • Modo router / repetidor / punto de acceso.<br>
