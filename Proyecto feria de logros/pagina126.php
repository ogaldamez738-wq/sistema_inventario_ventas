<?php
// producto-disipador-corsair-h100i.php - versión individual con precio final $119.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Disipador líquido Corsair H100i RGB Platinum</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://pcmig.com.mx/wp-content/uploads/2020/08/Corsair-H100i-RGB-Platinum-1.jpg" alt="Disipador líquido Corsair H100i RGB Platinum">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Refrigeración • Corsair • Novedades</div>
        <h1 id="prodTitle">Disipador líquido Corsair H100i RGB Platinum</h1>
        <div class="price" id="prodPrice">$119.99</div>

        <div class="desc" id="prodDesc">
          • Sistema de refrigeración líquida todo en uno de 240 mm.<br>
          • Iluminación RGB personalizable en bomba y ventiladores.<br>
          • Ventiladores ML Series con alto flujo de aire y bajo ruido.<br>
          • Compatible con sockets Intel y AMD.<br>
          • Software Corsair iCUE para control total.<br>
          • Marca: Corsair.
        </div>
