<?php
// producto-monitor-asus-vy279hgr.php - versión individual con precio final $159.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Monitor ASUS VY279HGR</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/IRVW4ra4YDbS4g9aIabxKKB5IMxaZdwXnK2vJ3W0.png" alt="Monitor ASUS VY279HGR">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Monitor • ASUS • Zona Gamer</div>
        <h1 id="prodTitle">Monitor ASUS VY279HGR</h1>
        <div class="price" id="prodPrice">$159.95</div>

        <div class="desc" id="prodDesc">
          • Pantalla Full HD de 27" con frecuencia de actualización de 144 Hz.<br>
          • Tecnología Adaptive-Sync para eliminar el tearing y el stuttering.<br>
          • Tiempo de respuesta de 1 ms para una experiencia de juego fluida.<br>
          • Panel IPS que ofrece colores precisos y amplios ángulos de visión.<br>
          • Modo Eye Care con reducción de luz azul y tecnología antirreflejo.<br>
          • Diseño ergonómico con inclinación ajustable.<br>
          • Ideal tanto para gaming competitivo como para uso multimedia.
        </div>
