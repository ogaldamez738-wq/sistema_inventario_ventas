<?php
// producto-hp-deskjet-2775.php - versión individual con precio final $79.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Impresora multifuncional HP DeskJet Ink Advantage 2775</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://sistema.langtecnologia.com.ar/img/qloud/6969/11022_1_1739658935.jpg" alt="Impresora multifuncional HP DeskJet Ink Advantage 2775">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Impresora • HP • Novedades</div>
        <h1 id="prodTitle">Impresora multifuncional HP DeskJet Ink Advantage 2775</h1>
        <div class="price" id="prodPrice">$79.99</div>

        <div class="desc" id="prodDesc">
          • Funciones: impresión, escaneo y copiado.<br>
          • Tecnología de inyección de tinta HP.<br>
          • Conectividad: USB y Wi-Fi para impresión inalámbrica.<br>
          • Compatible con HP Smart App para impresión desde dispositivos móviles.<br>
          • Diseño compacto y ligero para uso doméstico.<br>
          • Velocidad de impresión: hasta 7.5 ppm en negro y 5.5 ppm a color.<br>
          • Marca: HP.
        </div>
