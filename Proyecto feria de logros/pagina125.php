<?php
// producto-ssd-corsair-mp600.php - versión individual con precio final $199.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - SSD Corsair MP600 Gen4 PCIe 1TB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://m.media-amazon.com/images/I/81Uccbbk1OL.AC_SL1500.jpg" alt="SSD Corsair MP600 Gen4 PCIe 1TB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Almacenamiento • Corsair • Novedades</div>
        <h1 id="prodTitle">SSD Corsair MP600 Gen4 PCIe 1TB</h1>
        <div class="price" id="prodPrice">$199.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 1TB NVMe M.2 PCIe Gen4.<br>
          • Velocidades de lectura/escritura de hasta 4950/4250 MB/s.<br>
          • Diseño con disipador de calor para un rendimiento estable.<br>
          • Ideal para gaming, edición de video y tareas exigentes.<br>
          • Compatible con plataformas Intel y AMD.<br>
          • Marca: Corsair.
        </div>
