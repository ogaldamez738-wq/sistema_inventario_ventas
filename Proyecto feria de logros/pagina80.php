<?php
// producto-teclado-logitech-k250.php - versión individual
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado Inalámbrico Logitech K250</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68f2677e44cad.jpg" alt="Teclado Inalámbrico Logitech K250">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Periféricos • Logitech • Inalámbrico</div>
        <h1 id="prodTitle">Teclado Inalámbrico Logitech K250</h1>
        <div class="price" id="prodPrice">$49.95</div>

        <div class="desc" id="prodDesc">
          • Teclado inalámbrico compacto y silencioso.<br>
          • Conectividad USB con receptor nano Unifying.<br>
          • Alcance de hasta 10 metros.<br>
          • Diseño resistente a salpicaduras y teclas cómodas.<br>
          • Compatible con Windows, macOS, ChromeOS y Linux.
        </div>
