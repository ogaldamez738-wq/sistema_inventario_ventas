<?php
// producto-calculadora-casio-fx570es.php - Calculadora Casio FX-570ES Plus 2da Gen
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Calculadora Casio FX-570ES Plus 2da Gen</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada64750adf88d6b.jpg" alt="Calculadora Casio FX-570ES Plus 2da Gen">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Casio • FX-570ES • Zona Home Office</div>
        <h1 id="prodTitle">Calculadora Casio FX-570ES Plus 2da Gen</h1>
        <div class="price" id="prodPrice">$20.50</div>
        <div class="desc" id="prodDesc">
          Calculadora científica Casio FX-570ES Plus 2da generación, ideal para estudiantes y profesionales. Funciones avanzadas y diseño compacto.
        </div>
        <ul class="puntos">
          <li>Más de 417 funciones científicas</li>
          <li>Funciones de estadística y fracciones</li>
          <li>Pantalla natural de visualización de fórmulas</li>
          <li>Diseño compacto y duradero</li>
          <li>Ideal para estudios y trabajo profesional</li>
        </ul>
        <div class="options">
          <div class="qty">
