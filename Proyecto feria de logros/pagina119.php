<?php
// producto-teclado-hp-230.php - versión individual con precio final $35.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Teclado HP 230 inalámbrico con mouse</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://cdn.shopify.com/s/files/1/0564/5506/9881/files/28661.jpg?v=1720437352" alt="Teclado HP 230 inalámbrico con mouse">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Teclado y Mouse • HP • Novedades</div>
        <h1 id="prodTitle">Teclado HP 230 inalámbrico con mouse</h1>
        <div class="price" id="prodPrice">$35.00</div>

        <div class="desc" id="prodDesc">
          • Kit inalámbrico con teclado y mouse.<br>
          • Conexión Bluetooth estable y eficiente.<br>
          • Teclas de membrana silenciosas y cómodas.<br>
          • Diseño compacto y portátil para espacios reducidos.<br>
          • Compatible con Windows y Mac OS.<br>
          • Instalación Plug & Play sin software adicional.<br>
          • Marca: HP.
        </div>
