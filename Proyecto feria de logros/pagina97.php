<?php
// producto-asus-dual-rtx5060ti-16gb.php - versión individual con precio final $139.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Tarjeta de video ASUS Dual RTX 5060 Ti 16GB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/aOWnfPAjDtoeXAkfAwxF514V67Lbv3Q39dxnNERV.png" alt="Tarjeta de video ASUS Dual RTX 5060 Ti 16GB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Hardware • ASUS • Zona Gamer</div>
        <h1 id="prodTitle">Tarjeta de video ASUS Dual RTX 5060 Ti 16GB</h1>
        <div class="price" id="prodPrice">$139.95</div>

        <div class="desc" id="prodDesc">
          • GPU NVIDIA GeForce RTX 5060 Ti con arquitectura Ada Lovelace para rendimiento superior.<br>
          • 16 GB de memoria GDDR6 para juegos exigentes y multitareas sin limitaciones.<br>
          • Tecnología DLSS 3 y Ray Tracing para gráficos realistas y mayor fluidez.<br>
          • Sistema de refrigeración Dual Fan con ventiladores Axial-tech de alta durabilidad.<br>
          • Placa trasera de aluminio para una estructura rígida y mejor disipación del calor.<br>
          • Compatible con PCIe 4.0 y soporte para monitores 4K y VR.<br>
          • Software ASUS GPU Tweak III para control avanzado de rendimiento, temperatura y luces.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 2 años.
        </div>
      </div>
    </div>
  </div>
