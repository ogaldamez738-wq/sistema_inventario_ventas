<?php
// producto-tenaza-sprotek.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Tenaza ponchadora Sprotek STC-7388</title>
  <style>
    /* --- mismos estilos base --- */
    body {
      margin: 0;
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68559e184e4a6.jpg" alt="Tenaza Sprotek STC-7388">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Herramientas • Sprotek</div>
        <h1 id="prodTitle">Tenaza Ponchadora Sprotek STC-7388 RJ45</h1>
        <div class="price" id="prodPrice">$14.50</div>

        <div class="desc" id="prodDesc">
          • Herramienta profesional para conectores RJ45, RJ12 y RJ11.<br>
          • Compatible con cables Cat5, Cat6 y Cat7.<br>
          • Cuchillas de acero templado para mayor durabilidad.<br>
          • Mango ergonómico antideslizante.<br>
          • Corta, pela y poncha en una sola herramienta.<br>
          • Modelo: Sprotek STC-7388.
        </div>
