...
<div class="titulo-imagen">
  <img src="https://edgeup.asus.com/wp-content/uploads/2024/09/campaign-banner.jpg" alt="Banner Novedades">
</div>
...
<div class="main-contenedor">
  ...
  <section class="productos">
    ...
    <?php
    $productos = [
      ["nombre"=>"Laptop asus rog strix","precio"=>2299.95,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/v7lCIfcJkGmCSqVdbSSIAslkPKDlmOtbK9LmlHas.png","link"=>"pagina95.php"],
      ["nombre"=>"Monitor asus vy279hgr","precio"=>159.95,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/IRVW4ra4YDbS4g9aIabxKKB5IMxaZdwXnK2vJ3W0.png","link"=>"pagina96.php"],
      ["nombre"=>"Tarjeta de video asus dual rtx5060ti 16gb","precio"=>139.95,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/aOWnfPAjDtoeXAkfAwxF514V67Lbv3Q39dxnNERV.png","link"=>"pagina97.php"],
      ["nombre"=>"Case midtower asus tuf gt502","precio"=>279.00,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/fpXwdAhFmJr6cRS28z7HMxw5soD1ufl7VtnqALqK.png","link"=>"pagina98.php"],
      ["nombre"=>"Motherboard asus tuf b850m-plus wifi am5 ddr5","precio"=>299.00,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/r3Iymbj1mielO33smqxlg0fc2Ku8fEBQkcoJlVUZ.png","link"=>"pagina99.php"],
      ["nombre"=>"Laptop asus vivobook e1504ga-wb31 proc. intel core i3","precio"=>549.00,"marca"=>"ASUS","img"=>"https://apizd.zonadigitalsv.com/storage/productos/ysnQhYt09mWAUBLO9QVpndDHbdTHYAmbjtLQmG0P.png","link"=>"pagina100.php"],
