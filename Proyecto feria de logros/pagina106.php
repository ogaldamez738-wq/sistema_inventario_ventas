<?php
// producto-ssd-kingston-xs2000-1tb.php - versión individual con precio final $89.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - SSD Externo Kingston XS2000 1TB USB 3.2 Gen 2x2</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://promart.vteximg.com.br/arquivos/ids/8101028-1000-1000/image-1d6555313ab24692a1e49d14a7f45abe.jpg?v=638594399351900000">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">SSD Externo • Kingston • Novedades</div>
        <h1 id="prodTitle">SSD Externo Kingston XS2000 1TB USB 3.2 Gen 2x2</h1>
        <div class="price" id="prodPrice">$89.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 1TB.<br>
          • Interfaz: USB 3.2 Gen 2x2 Tipo-C.<br>
          • Velocidades de lectura y escritura: hasta 2,000 MB/s.<br>
          • Factor de forma compacto y portátil.<br>
          • Resistencia al agua y al polvo con clasificación IP55.<br>
          • Incluye funda de goma y cable USB-C a USB-C de 30 cm.<br>
          • Compatible con Windows, macOS, Linux, ChromeOS, Android, iOS y consolas.<br>
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 5 años.
        </div>
      </div>
    </div>
  </div>
