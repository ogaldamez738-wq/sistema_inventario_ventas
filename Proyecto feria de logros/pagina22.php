<?php
// producto-yx-s9865.php - Sistema de audio YX-S9865
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Sistema de Audio YX-S9865</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68eace981f265.jpg" alt="Sistema de Audio YX-S9865">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Sistema de Audio • YX-S9865 • Zona Cómputo</div>
        <h1 id="prodTitle">Sistema de Audio YX-S9865</h1>
        <div class="price" id="prodPrice">$250</div>

        <div class="desc" id="prodDesc">
          Sistema de audio YX-S9865 con conectividad Bluetooth, USB, SD/TF y control remoto. Potencia de salida 60W + 20W, 
          sonido estéreo envolvente de alta fidelidad, graves profundos y claridad cristalina. Incluye múltiples modos de reproducción, 
          luces LED decorativas y compatibilidad con dispositivos móviles y PC. Perfecto para salas de estudio, entretenimiento en casa 
          o fiestas, ofreciendo calidad de audio profesional en un diseño compacto y moderno.
        </div>
