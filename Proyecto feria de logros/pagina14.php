<?php
// producto-logitech-g522.php - Página de producto individual
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Headset inalámbricos Logitech G522 Lightspeed</title>
  <style>
    body {
      margin: 0;
...
<header>
  <a href="pagina1.php" class="logo" style="display:flex; align-items:center; gap:10px; text-decoration:none; color:white;">
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e548e1c1518.jpg" alt="Headset inalámbricos Logitech G522 Lightspeed">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Audio • Gamer</div>
        <h1 id="prodTitle">Headset inalámbricos Logitech G522 Lightspeed RGB</h1>
        <div class="price" id="prodPrice">$100</div>

        <div class="desc" id="prodDesc">
          Headset inalámbricos Logitech G522 Lightspeed 2.4GHz + Bluetooth con micrófono desmontable, sonido envolvente 7.1 y luces RGB programables.  
          Conecta vía USB o Bluetooth para una experiencia sin latencia y máxima comodidad.  
          Perfectos para gaming, trabajo remoto y reproducción multimedia.  
          <br><br><strong>Características destacadas:</strong>
          <ul>
            <li>Conectividad dual: 2.4GHz Lightspeed y Bluetooth</li>
            <li>Micrófono de alta calidad con cancelación de ruido</li>
            <li>Batería de hasta 20 horas de duración</li>
            <li>Iluminación RGB personalizable</li>
            <li>Compatibles con PC, PS5, y dispositivos móviles</li>
          </ul>
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 1 año Logitech.
        </div>
      </div>
    </div>
  </div>
