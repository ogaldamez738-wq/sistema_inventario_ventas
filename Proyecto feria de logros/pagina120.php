<?php
// producto-ssd-hp-ex900-pro.php - versión individual con precio final $69.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - SSD HP EX900 Pro M.2 1TB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.tecnologin.com.pe/files/productos/Unidad-en-estado-solido-HP-EX900-Pro-M.2-1TB-9XL77AA.webp" alt="SSD HP EX900 Pro M.2 1TB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Almacenamiento • HP • Novedades</div>
        <h1 id="prodTitle">SSD HP EX900 Pro M.2 1TB</h1>
        <div class="price" id="prodPrice">$69.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 1TB SSD M.2 NVMe.<br>
          • Velocidades de lectura hasta 3500 MB/s y escritura hasta 2900 MB/s.<br>
          • Ideal para gaming, edición de video y almacenamiento de alto rendimiento.<br>
          • Diseño compacto y eficiente energéticamente.<br>
          • Compatible con PCs y laptops con ranura M.2.<br>
          • Instalación Plug & Play.<br>
          • Marca: HP.
        </div>
