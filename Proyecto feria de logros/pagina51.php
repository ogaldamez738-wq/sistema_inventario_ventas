<?php
// producto-resma-papel-bond.php - Resma Papel Bond
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Resma Papel Bond</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada64750fdedc35a.jpg" alt="Resma Papel Bond">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Paperline • Resma Papel Bond • Zona Home Office</div>
        <h1 id="prodTitle">Resma Papel Bond Tamaño Carta</h1>
        <div class="price" id="prodPrice">$4.70</div>
        <div class="desc" id="prodDesc">
          Resma de papel bond tamaño carta de alta calidad, ideal para impresiones diarias y documentos importantes.
        </div>
        <ul class="puntos">
          <li>Tamaño carta (21.59 x 27.94 cm)</li>
          <li>Alta blancura y suavidad</li>
          <li>Compatible con impresoras láser y de inyección</li>
          <li>Paquete estándar de 500 hojas</li>
        </ul>
        <div class="options">
          <div class="qty">
        ...
        <div class="extra">
          <strong>Envío:</strong> 2-4 días hábiles • <strong>Garantía:</strong> 6 meses.
        </div>
      </div>
    </div>
  </div>
