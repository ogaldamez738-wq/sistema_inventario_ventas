<?php
// producto-ram-kingston.php - Memoria RAM Kingston DDR5 32GB
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Memoria RAM Kingston DDR5 32GB</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e7eaeac9139.jpg" alt="Memoria RAM Kingston DDR5 32GB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Memoria RAM • Kingston • DDR5 32GB • Zona Hardware</div>
        <h1 id="prodTitle">Memoria RAM Kingston DDR5 32GB 5600MHz Laptop KVR56S46BD8-32</h1>
        <div class="price" id="prodPrice">$110</div>

        <div class="desc" id="prodDesc">
          Memoria RAM Kingston DDR5 de 32GB a 5600MHz, diseñada para laptops de alto rendimiento, garantizando velocidad y estabilidad en multitarea, gaming y edición profesional.
        </div>

        <ul class="puntos">
          <li>32GB de capacidad DDR5 ultra rápida</li>
          <li>Frecuencia de 5600MHz para máximo rendimiento</li>
          <li>Compatible con laptops modernas</li>
          <li>Bajo consumo de energía y alta eficiencia</li>
          <li>Ideal para multitarea, gaming y edición de contenido</li>
        </ul>
