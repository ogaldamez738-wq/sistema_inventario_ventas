<?php
// producto-xiaomi-watch-3-ivory.php - versión individual con precio final $179.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Xiaomi Watch 3 Ivory</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://buketomnisportpweb.s3.us-east-2.amazonaws.com/products-images/NWeezl4fIquSonCkMDkuF07zLM6MVgJRidY656Wj.jpeg" alt="Xiaomi Watch 3 Ivory">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Smartwatch • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Xiaomi Watch 3 Ivory</h1>
        <div class="price" id="prodPrice">$179.00</div>

        <div class="desc" id="prodDesc">
          • Pantalla AMOLED de 1.43" con resolución 466x466 y brillo de 600 nits.<br>
          • Llamadas Bluetooth y asistente de voz integrado.<br>
          • Más de 150 modos deportivos y medición de oxígeno en sangre (SpO2).<br>
          • Batería de hasta 12 días de duración.<br>
          • GPS de doble banda y resistencia al agua 5 ATM.<br>
          • Carga magnética rápida y diseño ultraligero.<br>
          • Compatible con Android y iOS mediante la app Mi Fitness.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 2-5 días hábiles • <strong>Garantía:</strong> 1 año.
        </div>
      </div>
    </div>
  </div>
