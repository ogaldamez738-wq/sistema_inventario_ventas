<?php
// producto-xiaomi-redmi-pad-se.php - versión individual con precio final $719.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Tablet Xiaomi Redmi Pad SE 10.1"</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQU4nVsruMXhqw72pZLeztEFj2xeRkCQVN9cw&s" alt="Tablet Xiaomi Redmi Pad SE 10.1">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Tablet • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Tablet Xiaomi Redmi Pad SE 10.1"</h1>
        <div class="price" id="prodPrice">$719.00</div>

        <div class="desc" id="prodDesc">
          • Pantalla Full HD+ de 10.1" para disfrutar de tus contenidos.<br>
          • Procesador Snapdragon 680 de 8 núcleos.<br>
          • Memoria RAM de 6GB y almacenamiento de 128GB expandible.<br>
          • Batería de 8000 mAh con carga rápida USB-C.<br>
          • Cámara trasera de 8MP y frontal de 5MP.<br>
          • Diseño metálico ultradelgado y elegante.<br>
          • Sistema operativo MIUI for Pad basado en Android 13.
        </div>
