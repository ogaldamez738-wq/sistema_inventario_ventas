...
<?php
// producto-asus-rog-strix.php - versión limpia con precio final $1899.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop ASUS ROG Strix G713PV</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68d6d4179f337.jpg" alt="Laptop ASUS ROG Strix G713PV">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • ASUS • Zona gamer</div>
        <h1 id="prodTitle">Laptop ASUS ROG Strix G713PV</h1>
        <div class="price" id="prodPrice">$1899.95</div>

        <div class="desc" id="prodDesc">
          • Procesador AMD Ryzen 9 7845HX.<br>
          • RAM DDR5 16GB para multitarea fluida.<br>
          • SSD de 1TB para almacenamiento rápido.<br>
          • Tarjeta gráfica NVIDIA RTX 4060 8GB.<br>
          • Pantalla WQHD 17.3” para gaming y contenido multimedia.<br>
          • Diseño Eclipse Gray con teclado US.<br>
