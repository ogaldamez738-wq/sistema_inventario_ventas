<?php
// producto-logitech-mk250.php - versión individual con precio final $35.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Kit teclado y mouse inalámbrico Bluetooth Logitech MK250</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/sryExXadSkBEcWT9dILzbrlKs0Lxd18srMAUYYwy.png" alt="Kit teclado y mouse Logitech MK250">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Teclados y Mouse • Logitech • Novedades</div>
        <h1 id="prodTitle">Kit teclado y mouse inalámbrico Bluetooth Logitech MK250</h1>
        <div class="price" id="prodPrice">$35.00</div>

        <div class="desc" id="prodDesc">
          • Kit inalámbrico de teclado y mouse con conectividad Bluetooth.<br>
          • Diseño compacto y ergonómico para uso diario.<br>
          • Fácil configuración y compatibilidad con PC y laptops.<br>
          • Batería de larga duración para ambos dispositivos.<br>
          • Ideal para trabajo y entretenimiento en casa u oficina.<br>
          • Marca: Logitech.
        </div>
