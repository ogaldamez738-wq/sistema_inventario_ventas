<?php
// producto-mercusys.php - igual que los otros productos, solo cambian los datos
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Tarjeta PCI-E Mercusys</title>
  <style>
    body {
      margin: 0;
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e533c5a74bc.jpg" alt="Tarjeta PCI-E Mercusys">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Tarjetas de red</div>
        <h1 id="prodTitle">Tarjeta PCI-E Mercusys WiFi DualBand</h1>
        <div class="price" id="prodPrice">$150</div>

        <div class="desc" id="prodDesc">
          Tarjeta PCI-E Mercusys WiFi DualBand y Bluetooth 5.0 MA30E AC1200.  
          Ideal para mejorar la conectividad inalámbrica de tu PC, ofreciendo doble banda y conexión estable para gaming y trabajo.
        </div>
