<?php
// producto-hp-m24f-monitor.php - versión individual con precio final $159.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Monitor HP M24f 23.8'' Full HD IPS</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.electrocity.ie/acd-cgi/img/v1/wp-content/uploads/2023/01/hp-m24f-23.8-inch-full-hd-monitor-silver-2.jpg?quality=90&width=1500&height=1080" alt="Monitor HP M24f 23.8'' Full HD IPS">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Monitor • HP • Novedades</div>
        <h1 id="prodTitle">Monitor HP M24f 23.8'' Full HD IPS</h1>
        <div class="price" id="prodPrice">$159.99</div>

        <div class="desc" id="prodDesc">
          • Tamaño de pantalla: 23.8 pulgadas Full HD (1920x1080).<br>
          • Panel IPS con ángulos de visión amplios y colores precisos.<br>
          • Diseño ultradelgado y elegante para cualquier espacio.<br>
          • Conectividad: HDMI y VGA.<br>
          • Frecuencia de actualización: 75Hz.<br>
          • Tiempo de respuesta: 5ms.<br>
          • Marca: HP.
        </div>
