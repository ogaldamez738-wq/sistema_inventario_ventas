<?php
// producto-redmi-watch-4.php - Página individual del Redmi Watch 4
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Redmi Watch 4</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://m.media-amazon.com/images/I/61-qQyUBjFL._AC_SL1500_.jpg" alt="Redmi Watch 4">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Smartwatch • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Redmi Watch 4</h1>
        <div class="price" id="prodPrice">$119.00</div>

        <div class="desc" id="prodDesc">
          • Pantalla AMOLED de 1.97” con brillo de 600 nits y modo Always On.<br>
          • Cuerpo de aluminio premium y resistencia al agua 5 ATM.<br>
          • Monitoreo de frecuencia cardíaca, sueño, estrés y oxígeno en sangre.<br>
          • Más de 150 modos deportivos y seguimiento GPS integrado.<br>
          • Batería de hasta 20 días de duración.<br>
          • Compatible con Android y iOS mediante la app Mi Fitness.<br>
          • Correa intercambiable y diseño elegante.
        </div>
