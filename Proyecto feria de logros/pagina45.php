<?php
// producto-headset-maxell.php - Headset inalámbrico Bluetooth Maxell
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Headset inalámbrico Maxell</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68ed2c02e3322.jpg" alt="Headset inalámbrico Maxell">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Audio • Maxell • MaxPods HP-BT200 • Zona Móvil</div>
        <h1 id="prodTitle">Headset inalámbrico Bluetooth Maxell – Negro</h1>
        <div class="price" id="prodPrice">$10.70</div>
        <div class="desc" id="prodDesc">
          Headset inalámbrico Maxell MaxPods HP-BT200 con conexión Bluetooth, sonido claro y diseño cómodo para largas sesiones de uso.
        </div>
        <ul class="puntos">
          <li>Conexión Bluetooth estable</li>
          <li>Diseño ergonómico y cómodo</li>
          <li>Batería de larga duración</li>
          <li>Compatible con smartphones y tablets</li>
          <li>Color negro elegante</li>
        </ul>
        <div class="options">
          <div class="qty">
