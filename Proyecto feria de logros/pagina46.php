<?php
// producto-auricular-oraimo.php - Auricular TWS Bluetooth Oraimo FreePods Neo OTW-330S
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Auricular Oraimo FreePods Neo</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68dd64c60466a.jpg" alt="Auricular Oraimo FreePods Neo">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Audio • Oraimo • FreePods Neo OTW-330S • Zona Móvil</div>
        <h1 id="prodTitle">Auricular TWS Bluetooth Oraimo FreePods Neo – Negro</h1>
        <div class="price" id="prodPrice">$18.50</div>
        <div class="desc" id="prodDesc">
          Auriculares TWS Oraimo FreePods Neo OTW-330S con Bluetooth, sonido de alta fidelidad y hasta 50 horas de reproducción con estuche de carga.
        </div>
        <ul class="puntos">
          <li>Hasta 50 horas de batería total</li>
          <li>Conexión Bluetooth estable y rápida</li>
          <li>Diseño compacto y cómodo</li>
          <li>Compatibles con todos los smartphones</li>
          <li>Estuche de carga incluido</li>
        </ul>
        <div class="options">
          <div class="qty">
