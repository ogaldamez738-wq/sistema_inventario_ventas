<?php
// producto-impresora-epson-l4360.php - Impresora Epson L4360
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Impresora Epson L4360</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68ed256c5dc4e.jpg" alt="Impresora Epson L4360">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Epson • L4360 • Zona Home Office</div>
        <h1 id="prodTitle">Impresora Multifuncional Epson L4360</h1>
        <div class="price" id="prodPrice">$260.50</div>
        <div class="desc" id="prodDesc">
          Impresora multifuncional Epson L4360 con sistema EcoTank y conectividad WiFi, ideal para oficina y hogar.
        </div>
        <ul class="puntos">
          <li>Impresión, escaneo y copiado</li>
          <li>Conectividad WiFi y USB</li>
          <li>Tanque de tinta EcoTank recargable</li>
          <li>Formato máximo de impresión A4</li>
          <li>Alta eficiencia y bajo costo por página</li>
        </ul>
        <div class="options">
          <div class="qty">
