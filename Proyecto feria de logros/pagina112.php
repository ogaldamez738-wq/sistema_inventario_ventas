<?php
// producto-logitech-driving-force-palanca.php - versión individual con precio final $69.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Palanca Driving Force Logitech para G923/G29/G920</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/lKUZTDzVu6diqP5HQgzESjFkAwc2Qp61Xf5Cvmcj.png" alt="Palanca Driving Force Logitech">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Logitech • Novedades</div>
        <h1 id="prodTitle">Palanca Driving Force Logitech para G923/G29/G920</h1>
        <div class="price" id="prodPrice">$69.00</div>

        <div class="desc" id="prodDesc">
          • Palanca de cambios oficial para volantes Logitech G29, G920 y G923.<br>
          • Transmisión secuencial y H-shifter para experiencia realista.<br>
          • Construcción duradera con materiales de alta calidad.<br>
          • Compatible con PC y consolas PlayStation/Xbox según modelo.<br>
          • Mejora la inmersión en simuladores de carreras.<br>
          • Fácil instalación y ajuste ergonómico.<br>
          • Marca: Logitech.
        </div>
