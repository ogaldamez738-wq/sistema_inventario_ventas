<?php
// producto-cable-usb-c-ugreen.php - Cable USB tipo C UGREEN 2m
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cable USB tipo C UGREEN</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada67f46314f2407.jpg" alt="Cable USB tipo C UGREEN 2m">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • UGREEN • Cable USB tipo C • Zona Móvil</div>
        <h1 id="prodTitle">Cable USB tipo C UGREEN – 2 metros</h1>
        <div class="price" id="prodPrice">$5.50</div>
        <div class="desc" id="prodDesc">
          Cable USB tipo C macho a macho de 2 metros, con capacidad de carga hasta 60W y recubrimiento trenzado para mayor durabilidad.
        </div>
        <ul class="puntos">
          <li>Longitud: 2 metros</li>
          <li>Compatible con dispositivos USB-C</li>
          <li>Carga hasta 60W</li>
          <li>Revestimiento trenzado para mayor resistencia</li>
