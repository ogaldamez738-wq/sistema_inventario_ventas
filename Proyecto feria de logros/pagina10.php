<?php
// producto-lenovo.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<div class="product-wrap">
  <div class="product-card">
    ...
    <div class="product-info">
      <div>
        <div class="meta">Laptop • Lenovo • RTX2050</div>
        <h1 id="prodTitle">Laptop Lenovo LOQ i5 12va Gen</h1>
        <div class="price" id="prodPrice">$600</div>

        <div class="desc" id="prodDesc">
          Laptop Lenovo LOQ con procesador Intel Core i5-12450HX, RAM 8GB, SSD 512GB, pantalla FHD 15.6”, 
          tarjeta gráfica RTX 2050 4GB, Windows 11 Home, teclado US, color Luna Grey (modelo 83LK0001US).
        </div>
