<?php
// producto-camara-nexxt.php - versión individual con precio final $84.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Cámara de Videovigilancia Nexxt Solutions Smart Home</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68f26b72a1c20.jpg" alt="Cámara de Videovigilancia Nexxt Solutions Smart Home">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Seguridad • Nexxt • Smart Home</div>
        <h1 id="prodTitle">Cámara de Videovigilancia Nexxt Solutions Smart Home</h1>
        <div class="price" id="prodPrice">$84.99</div>

        <div class="desc" id="prodDesc">
          • Cámara Wi-Fi con resolución Full HD 1080p.<br>
          • Detección de movimiento y visión nocturna infrarroja.<br>
          • Audio bidireccional (micrófono y altavoz integrados).<br>
          • Compatible con Alexa y Google Assistant.<br>
          • Control remoto mediante aplicación móvil Nexxt Home.
        </div>
