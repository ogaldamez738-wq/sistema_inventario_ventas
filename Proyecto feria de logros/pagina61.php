<?php
// producto-lenovo-loq.php - versión limpia con precio final $1899.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop Lenovo Loq</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e68c50803f1.jpg" alt="Laptop Lenovo Loq">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • Lenovo • Zona gamer</div>
        <h1 id="prodTitle">Laptop Lenovo Loq</h1>
        <div class="price" id="prodPrice">$1899.00</div>

        <div class="desc" id="prodDesc">
          • Procesador Intel Core i5 12450HX.<br>
          • RAM 8GB para tareas cotidianas.<br>
          • SSD de 512GB para almacenamiento rápido.<br>
          • NVIDIA RTX 2050 4GB para gaming casual y multimedia.<br>
          • Pantalla FHD 15.6”.<br>
          • Windows 11 Home preinstalado, teclado US, acabado Luna Grey.
        </div>
