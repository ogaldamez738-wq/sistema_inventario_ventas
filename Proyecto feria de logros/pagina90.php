<?php
// producto-silla-razer-iskur-v2.php - versión individual con precio final $449.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Silla Profesional Razer Iskur V2</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/mReG7iGqKbEwBqVkaMbu73yW962O1clyK7j1yTVb.png" alt="Silla Profesional Razer Iskur V2">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorio • Razer • Novedades</div>
        <h1 id="prodTitle">Silla Profesional Razer Iskur V2</h1>
        <div class="price" id="prodPrice">$449.00</div>

        <div class="desc" id="prodDesc">
          • Soporte lumbar 6D adaptable y ajustable.<br>
          • Reclinación de respaldo hasta 152°.<br>
          • Reposabrazos 4D ajustables.<br>
          • Tapizado en cuero EPU de alta calidad.<br>
          • Estructura de acero reforzado para máxima durabilidad.<br>
          • Almohadilla para la cabeza de espuma viscoelástica.<br>
          • Peso máximo recomendado: 136 kg.<br>
          • Altura recomendada: entre 165 y 200 cm.<br>
          • Ideal para largas sesiones de juego o trabajo.
        </div>
