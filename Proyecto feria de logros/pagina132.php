<?php
// producto-nintendo-switch2-bundle-mkw.php - versión individual con precio final $679.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Nintendo Switch 2 Bundle MKW</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/9yDiH5G0AkQh5AMJRNWJFYDIo3NC4fFpnYnMxIRz.png" alt="Consola Nintendo Switch 2 Bundle MKW">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Consola • NINTENDO • Zona Gamer</div>
        <h1 id="prodTitle">Consola Nintendo Switch 2 Bundle MKW</h1>
        <div class="price" id="prodPrice">$679.00</div>

        <div class="desc" id="prodDesc">
          • Nueva generación de la consola híbrida de Nintendo.<br>
          • Pantalla FHD de 7.9 pulgadas con soporte <strong>HDR</strong> y frecuencia de hasta <strong>120Hz</strong>.<br>
          • Procesador optimizado para gráficos fluidos y rendimiento mejorado.<br>
          • Almacenamiento interno de <strong>256GB</strong> con ranura para microSD.<br>
          • Compatible con juegos físicos y digitales.<br>
          • Incluye bundle especial con <strong>Mario Kart 8 Deluxe</strong>.<br>
          • Conectividad inalámbrica Bluetooth y Wi-Fi de doble banda.<br>
          • Diseño portátil y base para conexión al televisor.<br>
          • Modelo: SGP-KB6EA • Marca: <strong>NINTENDO</strong>.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 3-5 días hábiles • <strong>Garantía:</strong> 1 año oficial.
        </div>
      </div>
    </div>
  </div>
