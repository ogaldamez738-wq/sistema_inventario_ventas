<?php
// producto-tarjeta-mercusys.php - igual que tu layout original, solo se cambian los datos del producto
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Tarjeta PCI-E Mercusys WiFi Dualband</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    ...
    <div class="product-info">
      <div>
        <div class="meta">Zona Redes • Adaptador • WiFi Dualband</div>
        <h1 id="prodTitle">Tarjeta PCI-E Mercusys WiFi Dualband y Bluetooth 5.0 MA30E AC1200</h1>
        <div class="price" id="prodPrice">$12.50</div>

        <div class="desc" id="prodDesc">
          • Tarjeta PCI-E de alta velocidad AC1200.<br>
          • Conectividad WiFi Dual Band (2.4GHz / 5GHz).<br>
          • Incluye módulo Bluetooth 5.0 integrado.<br>
          • Ideal para PCs de escritorio y juegos online.<br>
          • Marca: Mercusys – Modelo MA30E.
        </div>
