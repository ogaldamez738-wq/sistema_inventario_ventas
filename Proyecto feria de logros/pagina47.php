<?php
// producto-cubo-carga-anker.php - Cubo de carga 45W USB-C Anker A2643J11
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Cubo de carga 45W Anker</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68dc0add4abd1.jpg" alt="Cubo de carga 45W Anker">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Accesorios • Anker • Cubo de carga 45W • Zona Móvil</div>
        <h1 id="prodTitle">Cubo de carga 45W USB-C Anker – Negro</h1>
        <div class="price" id="prodPrice">$14.50</div>
        <div class="desc" id="prodDesc">
          Cubo de carga Anker A2643J11 de 45W con puerto USB-C, ideal para cargar smartphones, tablets y otros dispositivos rápidamente.
        </div>
        <ul class="puntos">
          <li>Potencia de 45W para carga rápida</li>
          <li>Puerto USB-C universal</li>
          <li>Protección contra sobrecarga y cortocircuito</li>
