<?php
// producto-ps5-slim-digital.php - versión individual con precio final $700.00
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - PlayStation 5 Slim Edición Digital 1TB</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/3pmvU30B9cisaSx3JBTtI8YZjXV27ATjt0mROFmt.png" alt="PlayStation 5 Slim Edición Digital 1TB">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Consola • SONY • Zona Gamer</div>
        <h1 id="prodTitle">Consola Sony PlayStation 5 Slim Edición Digital 4K HDR 1TB Astro Bot y Gran Turismo 7</h1>
        <div class="price" id="prodPrice">$700.00</div>

        <div class="desc" id="prodDesc">
          • Nueva versión <strong>PlayStation 5 Slim Edición Digital</strong> con diseño más compacto y almacenamiento de 1TB.<br>
          • Resolución <strong>4K HDR</strong> para una experiencia visual de última generación.<br>
          • Procesador AMD Ryzen Zen 2 y GPU RDNA 2 para gráficos ultra realistas.<br>
          • Incluye los juegos <strong>Astro Bot</strong> y <strong>Gran Turismo 7</strong> en formato digital.<br>
          • Sistema de refrigeración mejorado y ventiladores optimizados.<br>
          • Tecnología <strong>Ray Tracing</strong> y sonido 3D Tempest AudioTech.<br>
          • Compatible con mando DualSense con retroalimentación háptica y gatillos adaptativos.<br>
          • Conectividad: Wi-Fi 6, Bluetooth 5.1, HDMI 2.1 y puerto USB-C.<br>
          • Marca: <strong>SONY</strong> • Color: Blanco con negro.
        </div>
        ...
        <div class="extra">
          <strong>Envío:</strong> 2-5 días hábiles • <strong>Garantía:</strong> 1 año oficial.
        </div>
      </div>
    </div>
  </div>
