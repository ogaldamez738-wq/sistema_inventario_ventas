<?php
// producto-lampara-xiaomi.php - Página individual de la Lámpara Inteligente Mi Smart Lamp
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Lámpara Inteligente Mi Smart Lamp</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://http2.mlstatic.com/D_NQ_NP_794978-MPE92312705782_092025-O.webp" alt="Lámpara Inteligente Mi Smart Lamp">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Lámpara • Xiaomi • Ofertas</div>
        <h1 id="prodTitle">Lámpara Inteligente Mi Smart Lamp</h1>
        <div class="price" id="prodPrice">$59.00</div>

        <div class="desc" id="prodDesc">
          • Iluminación regulable con diferentes tonos de luz.<br>
          • Control remoto vía app Mi Home.<br>
          • Compatible con asistentes de voz como Alexa y Google Home.<br>
          • Diseño minimalista y elegante para cualquier espacio.
        </div>
