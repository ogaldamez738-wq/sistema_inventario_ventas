<?php
// producto-lenovo-ideapad.php - versión limpia con precio final $400
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Laptop Lenovo IdeaPad</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada688ba6e7bc5f2.jpg" alt="Laptop Lenovo IdeaPad">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Laptop • Lenovo • Zona Cómputo</div>
        <h1 id="prodTitle">Laptop Lenovo IdeaPad Slim 3</h1>
        <div class="price" id="prodPrice">$400</div>

        <div class="desc" id="prodDesc">
          La Lenovo IdeaPad Slim 3 combina un diseño delgado y ligero con un rendimiento potente gracias a su procesador AMD Ryzen 7 5825U, 
          16GB de RAM y SSD de 512GB. Ideal para trabajo, estudio y entretenimiento con pantalla FHD de 15.6”, gráficos integrados de alta calidad, 
          teclado cómodo y batería de larga duración. Perfecta para quienes buscan eficiencia y estilo en un solo equipo.
        </div>
