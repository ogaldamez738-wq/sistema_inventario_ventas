<?php
// producto-dispensador-nexxt.php - versión individual con precio final $129.95
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Dispensador Inteligente de Agua y Alimento Nexxt</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      ...
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68f26d584bc9c.jpg" alt="Dispensador Inteligente de Agua y Alimento Nexxt">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Smart Home • Nexxt • Novedades</div>
        <h1 id="prodTitle">Dispensador Inteligente de Agua y Alimento Nexxt</h1>
        <div class="price" id="prodPrice">$129.95</div>

        <div class="desc" id="prodDesc">
          • Alimenta y abastece de agua a tu mascota automáticamente.<br>
          • Control remoto desde app móvil.<br>
          • Compatible con Wi-Fi 2.4GHz y Alexa.<br>
          • Capacidad: 4 litros de alimento seco.<br>
          • Marca: Nexxt Solutions Smart Home.
        </div>
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  addBtn.addEventListener('click', () => {
    ...
    const producto = { nombre, precio, ca
