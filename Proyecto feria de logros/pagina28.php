<?php
// producto-case-msi.php - Case Mini ATX MSI
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Case Mini ATX MSI</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e3e2b5bd110.jpg" alt="Case Mini ATX MSI">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Case • MSI • Mini ATX • Zona Hardware</div>
        <h1 id="prodTitle">Case Mini ATX MSI PAG PANO M110A Tempered Glass</h1>
        <div class="price" id="prodPrice">$60</div>

        <div class="desc" id="prodDesc">
          Case Mini ATX MSI PAG PANO M110A con panel lateral de vidrio templado, incluye 3 ventiladores preinstalados y diseño compacto para setups modernos.
        </div>

        <ul class="puntos">
          <li>Panel lateral de vidrio templado</li>
          <li>3 ventiladores incluidos para buena refrigeración</li>
          <li>Diseño compacto Mini ATX</li>
          <li>Espacio optimizado para componentes</li>
          <li>Estética moderna con iluminación opcional</li>
        </ul>
