<?php
// producto-ram-corsair-vengeance-lpx-16gb.php - versión individual con precio final $84.99
?>
<!DOCTYPE html>
<html lang="es">
<head>
...
<title>Tecnozone - Memoria RAM Corsair Vengeance LPX 16GB DDR4 3200MHz</title>
<style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://www.impacto.com.pe/storage/products/md/174525166438065.webp" alt="Memoria RAM Corsair Vengeance LPX 16GB DDR4 3200MHz">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Memoria RAM • Corsair • Novedades</div>
        <h1 id="prodTitle">Memoria RAM Corsair Vengeance LPX 16GB DDR4 3200MHz</h1>
        <div class="price" id="prodPrice">$84.99</div>

        <div class="desc" id="prodDesc">
          • Capacidad: 16GB DDR4.<br>
          • Frecuencia: 3200MHz para un rendimiento estable y rápido.<br>
          • Perfil bajo (Low Profile) ideal para gabinetes compactos.<br>
          • Compatible con Intel XMP 2.0 para overclocking sencillo.<br>
          • Diseñada para gaming y tareas de alto rendimiento.<br>
          • Marca: Corsair Vengeance.
        </div>
