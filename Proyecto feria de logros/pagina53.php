<?php
// producto-escritorio-aerocool.php - Escritorio Gaming Aerocool
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Escritorio Gaming Aerocool</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68a78d2791b1c.jpg" alt="Escritorio Gaming Aerocool">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Home Office • Aerocool • GD3-RGB • Zona Home Office</div>
        <h1 id="prodTitle">Escritorio Gaming Aerocool GD3-RGB</h1>
        <div class="price" id="prodPrice">$144.50</div>
        <div class="desc" id="prodDesc">
          Escritorio gaming Aerocool con iluminación RGB, dimensiones 117x67x75cm y soporte de hasta 80kg.
        </div>
        <ul class="puntos">
          <li>Superficie amplia y resistente</li>
          <li>Iluminación RGB personalizable</li>
          <li>Diseño ergonómico para gamers y home office</li>
          <li>Soporta hasta 80kg</li>
        </ul>
        <div class="options">
          <div class="qty">
        ...
        <div class="extra">
          <strong>Envío:</strong> 4-6 días hábiles • <strong>Garantía:</strong> 1 año.
        </div>
      </div>
    </div>
  </div>
