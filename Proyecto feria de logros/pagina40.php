<?php
// producto-roku-streaming.php - Roku Streaming Stick
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Roku Streaming Stick</title>
  <style>
    /* Mantener todos los estilos idénticos a la plantilla base */
    ...
    .desc { color:#333; font-size:15px; line-height:1.5; margin-bottom:12px; }
    .puntos { margin-top:10px; margin-bottom:22px; padding-left:18px; color:#333; font-size:14px; }
    .puntos li { margin-bottom:6px; }
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://apizd.zonadigitalsv.com/storage/productos/vCxtiEVwdyaezoRpnHjhSIIpI6EAWYLXEUyDYgm8.png" alt="Roku Streaming Stick">
    </div>
    <div class="product-info">
      <div>
        <div class="meta">Streaming • Roku • 4K HDR • Zona Electrónica</div>
        <h1 id="prodTitle">Roku Streaming Stick Player TV 3830MX 4K HDR</h1>
        <div class="price" id="prodPrice">$48.50</div>
        <div class="desc" id="prodDesc">
          Transforma cualquier TV en una smart TV con el Roku Streaming Stick 4K HDR. Accede a Netflix, YouTube, Prime Video y más, con una interfaz intuitiva y control remoto incluido.
        </div>
        <ul class="puntos">
          <li>Streaming 4K HDR con alta calidad de imagen</li>
          <li>Control remoto con acceso rápido a apps</li>
          <li>Compatible con la mayoría de televisores HDMI</li>
          <li>Fácil instalación y uso intuitivo</li>
          <li>Acceso a apps de streaming populares como Netflix y YouTube</li>
        </ul>
        <div class="options">
          <div class="qty">
...
<footer class="small">© 2025 Tecnozone - Todos los derechos reservados</footer>
