<?php
// producto-fuente-msi.php - Fuente de poder MSI MAG
?>
<!DOCTYPE html>
<html lang="es">
<head>
  ...
  <title>Tecnozone - Fuente de poder MSI MAG</title>
  <style>
...
<div class="product-wrap">
  <div class="product-card">
    <div class="product-media">
      <img id="prodImage" src="https://api.zonadigitalsv.com/storage/products/imagen_generada68e3df31c66ba.jpg" alt="Fuente de poder MSI MAG">
    </div>

    <div class="product-info">
      <div>
        <div class="meta">Fuente de poder • MSI • MAG • Zona Hardware</div>
        <h1 id="prodTitle">Fuente de poder MSI MAG A1250GL PCIe5 1250W 80+Gold Full Modular</h1>
        <div class="price" id="prodPrice">$245</div>

        <div class="desc" id="prodDesc">
          Fuente de poder MSI MAG A1250GL de 1250W, certificación 80+ Gold, completamente modular, compatible con PCIe5 y diseñada para sistemas de alto rendimiento.
        </div>

        <ul class="puntos">
          <li>1250W de potencia confiable</li>
          <li>Certificación 80+ Gold para eficiencia energética</li>
          <li>Full modular para fácil instalación y organización de cables</li>
          <li>Compatible con PCIe5 y componentes modernos</li>
          <li>Diseño robusto y silencioso</li>
        </ul>
