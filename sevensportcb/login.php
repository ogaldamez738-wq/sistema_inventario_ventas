...
// ⚠️ ESTA ES LA LÓGICA CLAVE que te redirigía automáticamente.
if (isset($_SESSION['user_id'])) {
    // Si estás aquí, eliezer u otro usuario ya está logueado.
...
$DB_HOST = 'localhost';
$DB_USER = 'root';
$DB_PASS = ''; // Si tienes contraseña para 'root', ponla aquí.
...
if ($conn->connect_error) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['email']) && isset($_POST['contrasena'])) {
        ...
        if (empty($email) || empty($contrasena)) {
            ...
            // 1. Buscar usuario por email (usando sentencias preparadas)
            ...
            if ($stmt) {
                ...
                if ($stmt->num_rows == 1) {
                    ...
                    if (password_verify($contrasena, $contrasena_hash)) {
                        ...
                        $redirect_url = !empty($redirect_after_login) ? $redirect_after_login : "index.php";
    ...
    // La conexión se cerrará al final.
}
?>
<!DOCTYPE html>
<html lang="es">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <?php if (isset($_SESSION['logged_in']) && $_SESSION['logged_in'] === true): ?>
                            <span class="text-white mr-4">Hola, <?php echo htmlspecialchars($_SESSION['user_name']); ?></span>
        ...
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                <div>
                    ...
                    <p class="text-gray-400">Tu tienda de confianza para equipamiento deportivo profesional de fútbol y baloncesto.</p>
                </div>
